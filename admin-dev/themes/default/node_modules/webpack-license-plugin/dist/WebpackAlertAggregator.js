...
var WebpackAlertAggregator = /** @class */ (function () {
    ...
    WebpackAlertAggregator.prototype.flushAlerts = function (prefix) {
        var _a, _b;
        (_a = this.compilation.errors).push.apply(_a, __spread(this.errors.map(function (e) { return prefix + ": " + e; })));
        this.errors = [];
        (_b = this.compilation.warnings).push.apply(_b, __spread(this.warnings.map(function (w) { return prefix + ": " + w; })));
        this.warnings = [];
    };
