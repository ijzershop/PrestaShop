...
{/if}
	<div class="message-body">
		...
		{if isset($message.file_name)} <span class="message-product">&nbsp;<i class="icon-link"></i> <a href="{str_replace('/upload/','/upload/contactforms/', $message.file_name)|escape:'html':'UTF-8'}" class="_blank">{l s="Attachment" d='Admin.Catalog.Feature'}</a></span>{/if}
