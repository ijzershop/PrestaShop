...
<html lang="{$iso}">
	<head>
		...
		<link rel="apple-touch-icon" href="/themes/modernesmid/assets/favicons/{Configuration::get('MSTHEMECONFIG_FAVICON_SHOP',  Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id)}_favicons/apple-icon-60x60.png" />
