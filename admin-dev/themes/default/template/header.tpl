...
{if $display_header}
  ...
  <header id="header" class="bootstrap">
    <nav id="header_infos" role="navigation">
      ...
      {* Logo *}
      <a id="header_logo"  style="background: url('/img/{Configuration::get('PS_LOGO', null, null, 1)}')  left center/165px auto no-repeat !important;margin: 0;"  href="{$default_tab_link|escape:'html':'UTF-8'}" aria-label="{l s='PrestaShop logo' d='Admin.Navigation.Header'}"></a>
