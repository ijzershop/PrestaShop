 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const pt=Q,{$:gt}=window;class vt{extend(t){t.getContainer().on("click",".js-submit-row-action",(e=>{e.preventDefault();const n=gt(e.currentTarget),o=n.data("confirmMessage"),i=n.data("title"),r=n.data("method");if(i)this.showConfirmModal(n,t,o,i,r);else{if(o.length&&!window.confirm(o))return;this.postForm(n,r)}}))}postForm(t,e){const n=["GET","POST"].includes(e),o=gt("<form>",{action:t.data("url"),method:n?e:"POST"}).appendTo("body");n||o.append(gt("<input>",{type:"hidden",name:"_method",value:e})),o.submit()}showConfirmModal(t,e,n,o,r){const s=t.data("confirmButtonLabel"),a=t.data("closeButtonLabel"),c=t.data("confirmButtonClass");new Q({id:i(e.getId()),confirmTitle:o,confirmMessage:n,confirmButtonLabel:s,closeButtonLabel:a,confirmButtonClass:c},(()=>this.postForm(t,r))).show()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ct}=window;class Et{extend(t){t.getHeaderContainer().on("click",e.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",e.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const n=Ct(e.showModalForm(t.getId()));this.fillExportForm(n,t);const o=Ct(e.showModalGrid(t.getId()));o.modal("show"),o.on("click",_,(()=>n.submit()))}onExportSqlManagerClick(t){const n=Ct(e.showModalForm(t.getId()));this.fillExportForm(n,t),n.submit()}fillExportForm(t,e){const n=e.getContainer().find(r).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=Ct(d).find(h);let e="";return t.each(((t,n)=>{const o=Ct(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Bt{extend(t){const e=t.getContainer().find(m);e.find(f).prop("disabled",!0),e.find(p).on("input dp.change",(()=>{e.find(f).prop("disabled",!1),e.find(b).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ot}=window;Ot((()=>{const t=new y("catalog_price_rule");t.addExtension(new Et),t.addExtension(new M),t.addExtension(new E),t.addExtension(new j),t.addExtension(new vt),t.addExtension(new wt),t.addExtension(new kt),t.addExtension(new Bt)}))})(),window.catalog_price_rule=o})();