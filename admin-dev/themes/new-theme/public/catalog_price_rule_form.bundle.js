...
const { $ } = window;
$(() => {
  new _components_form_currency_symbol_updater__WEBPACK_IMPORTED_MODULE_1__["default"](_catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].currencyId, (symbol) => {
    if (symbol === "") {
      return;
    }
    ...
    if (reductionTypeSelect) {
      ...
      if (selectedReduction === "amount") {
        const reductionTypeAmountSymbols = document.querySelectorAll(_catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].reductionTypeAmountSymbol);
        if (reductionTypeAmountSymbols.length) {
          reductionTypeAmountSymbols.forEach((value) => {
            const elt = value;
  ...
  new _price_field_availability_handler__WEBPACK_IMPORTED_MODULE_2__["default"](_catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].initialPrice, _catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].price);
  new _components_form_reduction_tax_field_toggle__WEBPACK_IMPORTED_MODULE_0__["default"](_catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].reductionTypeSelect, _catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].includeTax, _catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].currencyId, _catalog_price_rule_form_map__WEBPACK_IMPORTED_MODULE_3__["default"].reductionTypeAmountSymbol);
});
