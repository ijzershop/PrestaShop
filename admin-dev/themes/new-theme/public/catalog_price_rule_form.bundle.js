 ...
 */
t.default={initialPrice:"#catalog_price_rule_leave_initial_price",price:"#catalog_price_rule_price",reductionType:".js-reduction-type-source",includeTax:".js-include-tax-target"}},409:function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var u=n(0),o=r(u),i=n(1),c=r(i),f=window.$,a=function(){function e(t,n){var r=this;return(0,o.default)(this,e),this.$sourceSelector=f(t),this.$targetSelector=f(n),this._handle(),this.$sourceSelector.on("change",function(){return r._handle()}),{}}return(0,c.default)(e,[{key:"_handle",value:function(){"percentage"===this.$sourceSelector.val()?this.$targetSelector.fadeOut():this.$targetSelector.fadeIn()}}]),e}();t.default=a},410:function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var u=n(0),o=r(u),i=n(1),c=r(i),f=window.$,a=function(){function e(t,n){var r=this;return(0,o.default)(this,e),this.$sourceSelector=f(t),this.$targetSelector=f(n),this._handle(),this.$sourceSelector.on("change",function(){return r._handle()}),{}}return(0,c.default)(e,[{key:"_handle",value:function(){var e=this.$sourceSelector.is(":checked");this.$targetSelector.prop("disabled",e)}}]),e}();t.default=a},487:function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}var u=n(410),o=r(u),i=n(409),c=r(i),f=n(408),a=r(f);/**
                   * Copyright since 2007 PrestaShop SA and Contributors
                   * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
                   *
                   * NOTICE OF LICENSE
