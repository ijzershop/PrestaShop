 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:_t}=window,Ct=function(t,e){_t.post(t).then((()=>window.location.assign(e)))},{$:Dt}=window;class xt{extend(t){t.getContainer().on("click",v,(t=>{Ct(Dt(t.currentTarget).data("url"),Dt(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class kt{extend(t){t.getHeaderContainer().on("click",D,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ot}=window;class Et{extend(t){t.getHeaderContainer().on("click",i.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",i.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=Ot(i.showModalForm(t.getId()));this.fillExportForm(e,t);const n=Ot(i.showModalGrid(t.getId()));n.modal("show"),n.on("click",O,(()=>e.submit()))}onExportSqlManagerClick(t){const e=Ot(i.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(s).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=Ot(g).find(b);let e="";return t.each(((t,n)=>{const o=Ot(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;class Tt{constructor(t=void 0){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=jt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;jt("tr",t.getContainer()).each((function(){const t=jt(this);jt(e.linkRowActionClickableFirst,t).each((function(){const o=jt(this),i=o.closest("td"),r=jt(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").mousedown((()=>{jt(window).mousemove((()=>{s=!0,jt(window).unbind("mousemove")}))})),r.mouseup((()=>{const t=s;if(s=!1,jt(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(N(n)||N(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;class At{extend(e){e.getContainer().on("click",t.submitAction,(t=>{this.submit(t,e)}))}submit(t,e){const n=Lt(t.currentTarget),o=n.data("confirm-message"),i=n.data("confirmTitle");void 0!==o&&o.length>0?void 0!==i?this.showConfirmModal(n,e,o,i):window.confirm(o)&&this.postForm(n,e):this.postForm(n,e)}showConfirmModal(t,e,n,o){const i=t.data("confirmButtonLabel"),s=t.data("closeButtonLabel"),a=t.data("confirmButtonClass");new vt({id:r(e.getId()),confirmTitle:o,confirmMessage:n,confirmButtonLabel:i,closeButtonLabel:s,confirmButtonClass:a},(()=>this.postForm(t,e))).show()}postForm(t,e){const n=Lt(x(e.getId()));n.attr("action",t.data("form-url")),n.attr("method",t.data("form-method")),n.submit()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Mt}=window;class $t{extend(t){t.getContainer().find(m).find(p).on("click",(t=>{t.preventDefault(),this.toggleValue(Mt(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){Mt("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}n(8243);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Rt}=window;class zt{constructor(t){this.$container=Rt(t),this.$container.on("click",".js-input-wrapper",(t=>{const e=Rt(t.currentTarget);this.toggleChildTree(e)})),this.$container.on("click",".js-toggle-choice-tree-action",(t=>{const e=Rt(t.currentTarget);this.toggleTree(e)}))}enableAutoCheckChildren(){this.$container.on("change",'input[type="checkbox"]',(t=>{const e=Rt(t.currentTarget);e.closest("li").find('ul input[type="checkbox"]').prop("checked",e.is(":checked"))}))}enableAllInputs(){this.$container.find("input").removeAttr("disabled")}disableAllInputs(){this.$container.find("input").attr("disabled","disabled")}toggleChildTree(t){const e=t.closest("li");e.hasClass("expanded")?e.removeClass("expanded").addClass("collapsed"):e.hasClass("collapsed")&&e.removeClass("collapsed").addClass("expanded")}toggleTree(t){const e=t.closest(".js-choice-tree-container"),n=t.data("action"),o={addClass:{expand:"expanded",collapse:"collapsed"},removeClass:{expand:"collapsed",collapse:"expanded"},nextAction:{expand:"collapse",collapse:"expand"},text:{expand:"collapsed-text",collapse:"expanded-text"},icon:{expand:"collapsed-icon",collapse:"expanded-icon"}};e.find("li").each(((t,e)=>{const i=Rt(e);i.hasClass(o.removeClass[n])&&i.removeClass(o.removeClass[n]).addClass(o.addClass[n])})),t.data("action",o.nextAction[n]),t.find(".material-icons").text(t.data(o.icon[n])),t.find(".js-toggle-text").text(t.data(o.text[n]))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const Ft=new(n(4936).EventEmitter),{$:Nt}=window;const Ht=class{constructor(t={}){const e=t||{};this.localeItemSelector=e.localeItemSelector||".js-locale-item",this.localeButtonSelector=e.localeButtonSelector||".js-locale-btn",this.localeInputSelector=e.localeInputSelector||".js-locale-input",this.selectedLocale=Nt(this.localeItemSelector).data("locale"),Nt("body").on("click",this.localeItemSelector,this.toggleLanguage.bind(this)),Ft.on("languageSelected",this.toggleInputs.bind(this))}refreshInputs(t){this.selectedLocale&&Ft.emit("languageSelected",{selectedLocale:this.selectedLocale,form:t})}toggleLanguage(t){const e=Nt(t.target),n=e.closest("form");this.selectedLocale=e.data("locale"),this.refreshInputs(n)}toggleInputs(t){const{form:e}=t;this.selectedLocale=t.selectedLocale;const n=e.find(this.localeButtonSelector),o=n.data("change-language-url");n.text(this.selectedLocale.toUpperCase()),e.find(this.localeInputSelector).addClass("d-none"),e.find(`${this.localeInputSelector}.js-locale-${this.selectedLocale}`).removeClass("d-none"),o&&this.saveSelectedLanguage(o,this.selectedLocale)}saveSelectedLanguage(t,e){Nt.post({url:t,data:{language_iso_code:e}})}},{$:qt}=window,Wt=({sourceElementSelector:t,destinationElementSelector:e,options:n={eventName:"input"}})=>{qt(document).on(n.eventName,`${t}`,(t=>{qt(t.currentTarget).closest("form").data("id")||qt(e).val(window.str2url(qt(t.currentTarget).val(),"UTF-8"))}))};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Gt{extend(t){const e=t.getContainer().find(w);e.find(y).prop("disabled",!0),e.find(C).on("input dp.change",(()=>{e.find(y).prop("disabled",!1),e.find(_).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ut}=window;class Vt{constructor({tokenFieldSelector:t,options:e={}}){Ut(t).tokenfield(e);const n=e.maxCharacters||0;if(n>0){Ut(t).siblings(".token-input").prop("maxlength",n)}}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Yt}=window;class Qt{constructor(t){this.id=t,this.$container=Yt(`#${this.id}`)}getContainer(){return this.$container}addExtension(t){t.extend(this)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Xt}=window;class Jt{extend(t){const e=t.getContainer();e.on("click",".js-remove-helper-block",(t=>{e.remove();const n=Xt(t.target),o=n.data("closeUrl"),i=n.data("cardName");o&&Xt.post(o,{close:1,name:i})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Kt}=window;Kt((()=>{const t=new j("cms_page_category");t.addExtension(new kt),t.addExtension(new Et),t.addExtension(new xt),t.addExtension(new A),t.addExtension(new Tt),t.addExtension(new At),t.addExtension(new Bt),t.addExtension(new yt),t.addExtension(new $t),t.addExtension(new It(t)),t.addExtension(new Gt);const e=new Ht;Wt({sourceElementSelector:'input[name^="cms_page_category[name]"]',destinationElementSelector:`${e.localeInputSelector}:not(.d-none) input[name^="cms_page_category[friendly_url]"]`}),new zt("#cms_page_category_parent_category");new zt("#cms_page_category_shop_association").enableAutoCheckChildren(),new Vt({tokenFieldSelector:'input[name^="cms_page_category[meta_keywords]"]',options:{createTokensOnBlur:!0}});const n=new j("cms_page");n.addExtension(new kt),n.addExtension(new Et),n.addExtension(new xt),n.addExtension(new A),n.addExtension(new $t),n.addExtension(new Bt),n.addExtension(new At),n.addExtension(new yt),n.addExtension(new It(n)),n.addExtension(new Gt),n.addExtension(new Tt);new Qt("cms-pages-showcase-card").addExtension(new Jt)}))})(),window.cms_page=o})();