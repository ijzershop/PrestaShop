(()=>{"use strict";var t={9632:t=>{t.exports=window.jQuery}},e={};function n(o){var i=e[o];if(void 0!==i)return i.exports;var r=e[o]={exports:{}};return t[o](r,r.exports,n),r.exports}n.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(t){if("object"==typeof window)return window}}(),n.r=t=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})};var o={};(()=>{n.r(o);var t=n(9632),e=Object.defineProperty,i=Object.getOwnPropertySymbols,r=Object.prototype.hasOwnProperty,s=Object.prototype.propertyIsEnumerable,a=(t,n,o)=>n in t?e(t,n,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[n]=o,l=(t,e)=>{for(var n in e||(e={}))r.call(e,n)&&a(t,n,e[n]);if(i)for(var n of i(e))s.call(e,n)&&a(t,n,e[n]);return t};
/**
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const z=_,N={moduleItemList:t=>`div.module-item-list[data-tech-name='${t}']`,moduleItem:t=>`.module-item[data-tech-name='${t}']`},W=t=>`#${t}`;var G=n(9632);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const F=N,{$:V}=window;class Q{constructor(){this.pendingRequest=!1,this.moduleActionMenuLinkSelector="button.module_action_menu_",this.moduleActionMenuInstallLinkSelector="button.module_action_menu_install",this.moduleActionMenuEnableLinkSelector="button.module_action_menu_enable",this.moduleActionMenuUninstallLinkSelector="button.module_action_menu_uninstall",this.moduleActionMenuDisableLinkSelector="button.module_action_menu_disable",this.moduleActionMenuEnableMobileLinkSelector="button.module_action_menu_enableMobile",this.moduleActionMenuDisableMobileLinkSelector="button.module_action_menu_disableMobile",this.moduleActionMenuResetLinkSelector="button.module_action_menu_reset",this.moduleActionMenuUpdateLinkSelector="button.module_action_menu_upgrade",this.moduleActionMenuDeleteLinkSelector="button.module_action_menu_delete",this.moduleItemListSelector=".module-item-list",this.moduleItemGridSelector=".module-item-grid",this.moduleItemActionsSelector=".module-actions",this.moduleActionModalDisableLinkSelector="a.module_action_modal_disable",this.moduleActionModalResetLinkSelector="a.module_action_modal_reset",this.moduleActionModalUninstallLinkSelector="a.module_action_modal_uninstall",this.forceDeletionOption="#force_deletion",this.eventEmitter=window.prestashop.component.EventEmitter,this.initActionButtons()}initActionButtons(){const t=this;V(document).on("click",this.forceDeletionOption,(function(){const e=V(t.moduleActionModalUninstallLinkSelector,V(F.moduleItemList(V(this).attr("data-tech-name"))));!0===V(this).prop("checked")?e.attr("data-deletion","true"):e.removeAttr("data-deletion")})),V(document).on("click",this.moduleActionMenuInstallLinkSelector,(function(){return t.dispatchPreEvent("install",this)&&t.confirmAction("install",this)&&t.requestToController("install",V(this))})),V(document).on("click",this.moduleActionMenuEnableLinkSelector,(function(){return t.dispatchPreEvent("enable",this)&&t.confirmAction("enable",this)&&t.requestToController("enable",V(this))})),V(document).on("click",this.moduleActionMenuUninstallLinkSelector,(function(){return t.dispatchPreEvent("uninstall",this)&&t.confirmAction("uninstall",this)&&t.requestToController("uninstall",V(this))})),V(document).on("click",this.moduleActionMenuDeleteLinkSelector,(function(){return t.dispatchPreEvent("delete",this)&&t.confirmAction("delete",this)&&t.requestToController("delete",V(this))})),V(document).on("click",this.moduleActionMenuDisableLinkSelector,(function(){return t.dispatchPreEvent("disable",this)&&t.confirmAction("disable",this)&&t.requestToController("disable",V(this))})),V(document).on("click",this.moduleActionMenuEnableMobileLinkSelector,(function(){return t.dispatchPreEvent("enableMobile",this)&&t.confirmAction("enableMobile",this)&&t.requestToController("enableMobile",V(this))})),V(document).on("click",this.moduleActionMenuDisableMobileLinkSelector,(function(){return t.dispatchPreEvent("disableMobile",this)&&t.confirmAction("disableMobile",this)&&t.requestToController("disableMobile",V(this))})),V(document).on("click",this.moduleActionMenuResetLinkSelector,(function(){return t.dispatchPreEvent("reset",this)&&t.confirmAction("reset",this)&&t.requestToController("reset",V(this))})),V(document).on("click",this.moduleActionMenuUpdateLinkSelector,(function(e){e.preventDefault();const n=V(`#${V(this).data("confirm_modal")}`),o=window.isShopMaintenance;if(1===n.length)return t.dispatchPreEvent("update",this)&&t.confirmAction("update",this)&&t.requestToController("update",V(this));{const e=document.createElement("a");e.classList.add("btn","btn-primary","btn-lg"),e.setAttribute("href",window.moduleURLs.maintenancePage),e.innerHTML=window.moduleTranslations.moduleModalUpdateMaintenance;new z({id:"confirm-module-update-modal",confirmTitle:window.moduleTranslations.singleModuleModalUpdateTitle,closeButtonLabel:window.moduleTranslations.moduleModalUpdateCancel,confirmButtonLabel:o?window.moduleTranslations.moduleModalUpdateUpgrade:window.moduleTranslations.upgradeAnywayButtonText,confirmButtonClass:o?"btn-primary":"btn-secondary",confirmMessage:o?"":window.moduleTranslations.moduleModalUpdateConfirmMessage,closable:!0,customButtons:o?[]:[e]},(()=>t.dispatchPreEvent("update",this)&&t.confirmAction("update",this)&&t.requestToController("update",V(this)))).show()}return!1})),V(document).on("click",this.moduleActionModalDisableLinkSelector,(function(){return t.requestToController("disable",V(t.moduleActionMenuDisableLinkSelector,V(F.moduleItemList(V(this).attr("data-tech-name")))))})),V(document).on("click",this.moduleActionModalResetLinkSelector,(function(){return t.requestToController("reset",V(t.moduleActionMenuResetLinkSelector,V(F.moduleItemList(V(this).attr("data-tech-name")))))})),V(document).on("click",this.moduleActionModalUninstallLinkSelector,(e=>{V(e.target).parents(".modal").on("hidden.bs.modal",(()=>t.requestToController("uninstall",V(t.moduleActionMenuUninstallLinkSelector,V(F.moduleItemList(V(e.target).attr("data-tech-name")))),V(e.target).attr("data-deletion"))))}))}getModuleItemSelector(){return V(this.moduleItemListSelector).length?this.moduleItemListSelector:this.moduleItemGridSelector}confirmAction(t,e){const n=V(W(V(e).data("confirm_modal")));return 1!==n.length||(n.first().modal("show"),!1)}dispatchPreEvent(t,e){const n=G.Event("module_card_action_event");return V(e).trigger(n,[t]),!1===n.isPropagationStopped()&&!1===n.isImmediatePropagationStopped()&&!1!==n.result}hasPendingRequest(){return this.pendingRequest}requestToController(t,e,n=!1,o=(()=>!0)){if(this.pendingRequest)return V.growl.warning({message:window.translate_javascripts["An action is already in progress. Please wait for it to finish."]}),!1;this.pendingRequest=!0;const i=this;let r=e.closest(this.moduleItemActionsSelector);const s=e.closest("form"),a=V('<button class="btn-primary-reverse onclick unbind spinner "></button>'),l=`//${window.location.host}${s.attr("action")}`,c=s.serializeArray();let d=!1;return"true"!==n&&!0!==n||c.push({name:"actionParams[deletion]",value:"true"}),V.ajax({url:l,dataType:"json",method:"POST",data:c,beforeSend(){r.hide(),r.after(a)}}).done((e=>{if(void 0===e)return void V.growl.error({message:"No answer received from server",fixed:!0});if(void 0!==e.status&&!1===e.status)return void V.growl.error({message:e.msg,fixed:!0});const o=Object.keys(e)[0];if(!1===e[o].status)return void V.growl.error({message:e[o].msg,fixed:!0});if(V.growl({message:e[o].msg,duration:6e3}),!0===e[o].refresh_needed)return void(d=!0);const s=i.getModuleItemSelector().replace(".","");let a=null;"delete"!==t||e[o].has_download_url?"uninstall"===t?(a=r.closest(`.${s}`),a.attr("data-installed","0"),a.attr("data-active","0"),"true"!==n&&!0!==n||e[o].has_download_url?this.eventEmitter.emit("Module Uninstalled",a):this.eventEmitter.emit("Module Delete",a)):"disable"===t?(a=r.closest(`.${s}`),a.addClass(`${s}-isNotActive`),a.attr("data-active","0"),this.eventEmitter.emit("Module Disabled",a)):"enable"===t?(a=r.closest(`.${s}`),a.removeClass(`${s}-isNotActive`),a.attr("data-active","1"),this.eventEmitter.emit("Module Enabled",a)):"install"===t?(a=r.closest(`.${s}`),a.attr("data-installed","1"),a.attr("data-active","1"),a.removeClass(`${s}-isNotActive`),this.eventEmitter.emit("Module Installed",a)):"update"!==t&&"upgrade"!==t||(a=r.closest(`.${s}`),this.eventEmitter.emit("Module Upgraded",a)):(a=r.closest(`.${s}`),this.eventEmitter.emit("Module Delete",a)),r=V(e[o].action_menu_html).replaceAll(r),r.hide()})).fail((()=>{const e=r.closest("module-item-list").data("techName");V.growl.error({message:`Could not perform action ${t} for module ${e}`,fixed:!0})})).always((()=>{d?document.location.reload():(r.fadeIn(),a.remove(),this.pendingRequest=!1,o&&o())})),!1}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
