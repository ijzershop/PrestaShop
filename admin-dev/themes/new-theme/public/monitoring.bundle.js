(()=>{"use strict";var t={9632:t=>{t.exports=window.jQuery}},e={};function n(o){var i=e[o];if(void 0!==i)return i.exports;var s=e[o]={exports:{}};return t[o](s,s.exports,n),s.exports}n.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(t){if("object"==typeof window)return window}}(),n.r=t=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})};var o={};(()=>{n.r(o);
/**
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:kt}=window;class Ct{constructor(t=void 0){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=kt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;kt("tr",t.getContainer()).each((function(){const t=kt(this);kt(e.linkRowActionClickableFirst,t).each((function(){const o=kt(this),i=o.closest("td"),s=kt(e.clickableTd,t).not(i);let r=!1;s.addClass("cursor-pointer").mousedown((()=>{kt(window).mousemove((()=>{r=!0,kt(window).unbind("mousemove")}))})),s.mouseup((()=>{const t=r;if(r=!1,kt(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(R(n)||R(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Et}=window;class xt{extend(n){n.getContainer().on("click",e.categoryDeleteAction,(e=>{e.preventDefault();const o=Et(t.deleteCategoriesModal(n.getId()));o.modal("show"),o.on("click",t.submitDeleteCategories,(()=>{const n=Et(e.currentTarget),i=n.data("category-id"),s=Et(t.categoriesToDelete),r=s.data("prototype").replace(/__name__/g,s.children().length),a=Et(Et.parseHTML(r)[0]);a.val(i),s.append(a);const c=o.find("form");c.attr("action",n.data("category-delete-url")),c.submit()}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Bt}=window;class Ot{extend(t){t.getContainer().find(r).on("click",l,(t=>{const e=Bt(t.currentTarget);e.hasClass("ps-switch")||t.preventDefault();const n=e.find("input:checked"),o=Boolean(n.val());Bt.post({url:e.data("toggle-url")}).then((t=>{if(t.status)return window.showSuccessMessage(t.message),void this.toggleButtonDisplay(e);this.showErrorMessage(t.message,n.prop("name"),!o)})).catch((t=>{const e=t.responseJSON;this.showErrorMessage(e.message,n.prop("name"),!o)}))}))}showErrorMessage(t,e,n){this.toggleSwitch(e,n),window.showErrorMessage(t)}toggleSwitch(t,e){const n=Bt(`[name="${t}"][value="1"]`),o=Bt(`[name="${t}"][value="0"]`);n.is(":checked")!==e&&n.prop("checked",e),o.is(":checked")===e&&o.prop("checked",!e)}toggleButtonDisplay(t){const e=t.hasClass("grid-toggler-icon-valid"),n=e?"grid-toggler-icon-not-valid":"grid-toggler-icon-valid",o=e?"grid-toggler-icon-valid":"grid-toggler-icon-not-valid",i=e?"clear":"check";t.removeClass(o),t.addClass(n),t.hasClass("material-icons")&&t.text(i)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Mt{extend(t){t.getHeaderContainer().on("click",v,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:At}=window;class Tt{extend(t){t.getHeaderContainer().on("click",i.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",i.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=At(i.showModalForm(t.getId()));this.fillExportForm(e,t);const n=At(i.showModalGrid(t.getId()));n.modal("show"),n.on("click",y,(()=>e.submit()))}onExportSqlManagerClick(t){const e=At(i.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(r).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=At(u).find(m);let e="";return t.each(((t,n)=>{const o=At(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;class St{constructor(t){this.id=t,this.$container=$t(`#${this.id}`)}getContainer(){return this.$container}addExtension(t){t.extend(this)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;class Dt{extend(t){const e=t.getContainer();e.on("click",".js-remove-helper-block",(t=>{e.remove();const n=Lt(t.target),o=n.data("closeUrl"),i=n.data("cardName");o&&Lt.post(o,{close:1,name:i})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Pt}=window;Pt((()=>{const t=new C("empty_category");t.addExtension(new O),t.addExtension(new A),t.addExtension(new Mt),t.addExtension(new yt),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new xt),t.addExtension(new jt),["no_qty_product_with_combination","no_qty_product_without_combination","disabled_product","product_without_image","product_without_description","product_without_price"].forEach((t=>{const e=new C(t);e.addExtension(new A),e.addExtension(new Tt),e.addExtension(new Mt),e.addExtension(new O),e.addExtension(new Ot),e.addExtension(new yt),e.addExtension(new It),e.addExtension(new vt),e.addExtension(new Ct),e.addExtension(new jt)}));new St("monitoringShowcaseCard").addExtension(new Dt)}))})(),window.monitoring=o})();