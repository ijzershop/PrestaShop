...
const initMultistoreDropdown = () => {
  ...
  const dataSetConfig = {
    ...
    onSelect(selectedItem, event) {
      ...
      window.location.href = _components_components_map__WEBPACK_IMPORTED_MODULE_4__["default"].multistoreHeader.setContextUrl(window.location.href, contextUrlLetter, selectedItem.id);
      return true;
    }
  };
