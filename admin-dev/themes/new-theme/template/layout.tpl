...
{if $display_header}
  <header id="header">
    ...
    <nav id="header_infos" class="main-header">
      ...
      <a id="header_logo" class="logo float-left" style="background: url('/img/{Configuration::get('PS_LOGO', null, null, 1)}') no-repeat 0!important" href="{$default_tab_link|escape:'html':'UTF-8'}"></a>
