 ...
 * @since 1.5
 */
class HTMLTemplatePhysicalOnCreditOrderSlip extends HTMLTemplate
{
    ...
    public function getHeader()
    {
        ...
        $this->smarty->assign(['header' => Context::getContext()->getTranslator()->trans('Op Rekening', [], 'Shop.Pdf')]);
    ...
    public function getContent()
    {
        ...
        $tpls = [
            ...
            'note_tab' => $this->smarty->fetch($this->getTemplate('physical-on-credit-order-slip.note-tab')),
            'total_tab' => $this->smarty->fetch($this->getTemplate('physical-on-credit-order-slip.total-tab')),
            'shipping_tab' => $this->smarty->fetch($this->getTemplate('physical-on-credit-order-slip.shipping-tab')),
        ];
