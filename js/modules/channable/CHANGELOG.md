...
### 3.3.15
- Added stock_available table for specific fields settings

### 3.3.14
- Backend interface for more detailed setting of shipping methods per country 

### 3.3.13
- Optimized Stock Update Query

### 3.3.12
- Implementation of new order endpoint

### 3.3.11
- New option to override tax information submitted by channable in new orders

### 3.3.10
- Newly submitted transaction_fee will be processed if available

### 3.3.9

- New feature expert setting "Assigned carrier based on the Shipping Method"
- Option to add advanced stock module data to the feed
- Cronjob for product stock updates, configurable setting for backend trigger

### 3.3.8

- Optimized Feed Query for improved performance
- New feature expert setting "Assign orders by ID to specific shipping status"
