...
class DynamicTools
{
    ...
    {
        return DynamicContext::getEmployeeProfileId() !== 1 && in_array((int) $id, $array, false);
    }
    ...
    {
        return DynamicContext::getEmployeeProfileId() === 1;
    }
    ...
    public static function checkAddress()
    {
        ...
        $id_customer = DynamicContext::getCookieCustomerId();
        if ($id_customer) {
            $id_address_delivery = DynamicContext::getCartAddressDelivery();
    ...
    /**
     * @deprecated Use DynamicContext static methods
     *
     * @return \Context
     */
    ...
    {
        return is_array($_POST) && !count($_POST);
    }
    ...
    public static function stripRoot($path)
    {
