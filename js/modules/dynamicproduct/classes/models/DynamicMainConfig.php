...
class DynamicMainConfig extends DynamicObject
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'cron_key' => ['type' => self::TYPE_STRING],
            'gemini_api_key' => ['type' => self::TYPE_STRING],
        ],
    ];
    ...
    {
        $main_config = new DynamicMainConfig(1);
        if (!\Validate::isLoadedObject($main_config)) {
            $main_config = new DynamicMainConfig();
            $main_config->id = 1;
            $main_config->force_id = true;
            $main_config->add();
        }
