...
class CountryInputField extends DynamicInputField
{
    public $type = _DP_COUNTRY_;
    ...
    public function displayValue()
    {
        ...
        $id_option = $this->getFirstOption();
        if (!$id_option) {
            return $this->value_formatted;
        }

        $country = new \Country($id_option, DynamicContext::getLanguageId());
