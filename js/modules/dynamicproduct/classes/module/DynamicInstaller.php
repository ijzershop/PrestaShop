...
class DynamicInstaller
{
    ...
    private $hooks_front = [
        ...
        'actionObjectCartDuplicateAfter',
    ...
    public function copyFiles()
    {
        ...
        $folder_helper = new FolderHelper($this->module);
    ...
    public function execUninstallScript()
    {
        ...
        if (is_array($tables)) {
            foreach ($tables as $table) {
                ...
                $sql = 'DROP TABLE IF EXISTS `' . bqSQL($table) . '`;';
                $sql = str_replace('ps_dynamicproduct', bqSQL(_DB_PREFIX_ . $this->module->name), $sql);
