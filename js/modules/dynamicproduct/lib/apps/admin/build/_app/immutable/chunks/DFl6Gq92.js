import { B as html, Et as update, Ft as push, G as if_block, Ot as user_derived, Pt as pop, Q as from_svg, T as attribute_effect, Tt as state, Ut as reset, X as comment, Y as append, Z as from_html, n as onDestroy, ot as get, s as rest_props, vt as child, xt as proxy, yt as first_child } from "./DUscB9kS.js";
import { f as dpa } from "./BIEFGHhw.js";
const dict = proxy({ translations: {} });
...
function _(str) {
	...
	let trans = dict.translations?.[hash];
	if (trans) {
...
function __(strings, id_lang) {
	return strings?.[id_lang] || strings?.[dpa.id_default_lang];
}
...
function mergeIconData(parent, child$1) {
	...
	} else if (key in child$1) result[key] = child$1[key];
...
export { dict as i, _ as n, __ as r, Icon as t };
