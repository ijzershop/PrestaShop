...
var root_28 = from_html(`<span class="font-mono"> </span>`);
...
function _page($$anchor, $$props) {
					...
					component(node_1, () => Card_content, ($$anchor$4, Card_Content) => {
						Card_Content($$anchor$4, {
							...
							children: ($$anchor$5, $$slotProps$1) => {
								...
								each(div, 21, () => $$props.data.languages, ({ id_lang, iso_code }) => id_lang, ($$anchor$6, $$item) => {
									...
									Label(node_2, {
										...
										children: ($$anchor$7, $$slotProps$2) => {
											next();
											var text$1 = text();
											template_effect(($0) => set_text(text$1, `${$0 ?? ""} (${iso_code() ?? ""})`), [() => _("Name")]);
									...
									var node_3 = sibling(node_2, 2);
									{
										...
										let $1 = user_derived(() => _("Unit name"));
										let $2 = user_derived(() => get(id) ? $$props.data.units[get(id)].name[id_lang()] : null);
										Input(node_3, {
											get id() {
												return `name-${id_lang() ?? ""}`;
											},
											...
											get ref() {
												return name_inputs[id_lang()];
											},
											set ref($$value) {
												name_inputs[id_lang()] = $$value;
											}
										});
									}
								...
								Label(node_4, {
									...
									children: ($$anchor$6, $$slotProps$2) => {
										next();
										var text_1 = text();
										template_effect(($0) => set_text(text_1, $0), [() => _("Symbol")]);
								...
								{
									let $0 = user_derived(() => _("e.g., m, kg, cm²"));
									let $1 = user_derived(() => get(id) ? $$props.data.units[get(id)].symbol : "");
									Input(node_5, {
										get id() {
											return `symbol-${get(id) ?? ""}`;
										},
								...
								{
									let $0 = user_derived(() => get(id) ? $$props.data.units[get(id)].displayed : true);
									Checkbox(node_6, {
										id: "displayed",
										name: "displayed",
										get checked() {
								...
								Label(sibling(node_6, 2), {
									...
									children: ($$anchor$6, $$slotProps$2) => {
										next();
										var text_2 = text();
										template_effect(($0) => set_text(text_2, $0), [() => _("Displayed")]);
	...
	let name_inputs = proxy(Object.fromEntries($$props.data.languages.map((l) => [l.id_lang, null])));
	async function toggle_unit(id) {
	...
	async function delete_unit(id) {
		if (!confirm(_("Are you sure you want to delete this unit?"))) return;
				...
				component(first_child(fragment_11), () => Card_title, ($$anchor$3, Card_Title) => {
					Card_Title($$anchor$3, {
						children: ($$anchor$4, $$slotProps$1) => {
							next();
							var text_5 = text();
							template_effect(($0) => set_text(text_5, $0), [() => _("Units Configuration")]);
													...
													component(node_21, () => Table_head, ($$anchor$9, Table_Head_2) => {
														Table_Head_2($$anchor$9, {
															children: ($$anchor$10, $$slotProps$4) => {
																next();
																var text_8 = text();
																template_effect(($0) => set_text(text_8, $0), [() => _("Symbol")]);
													...
													component(node_22, () => Table_head, ($$anchor$9, Table_Head_3) => {
														Table_Head_3($$anchor$9, {
															children: ($$anchor$10, $$slotProps$4) => {
																next();
																var text_9 = text();
																template_effect(($0) => set_text(text_9, $0), [() => _("Displayed")]);
							...
							component(sibling(node_17, 2), () => Table_body, ($$anchor$5, Table_Body) => {
								Table_Body($$anchor$5, {
									children: ($$anchor$6, $$slotProps$2) => {
										...
										each(first_child(fragment_22), 17, () => reorder($$props.data.units), ({ id, name: unit_name, symbol, displayed }) => id, ($$anchor$7, $$item) => {
											let id = () => get($$item).id;
											let unit_name = () => get($$item).name;
											let symbol = () => get($$item).symbol;
											let displayed = () => get($$item).displayed;
														...
														children: ($$anchor$9, $$slotProps$3) => {
															...
															component(node_28, () => Table_cell, ($$anchor$10, Table_Cell_1) => {
																Table_Cell_1($$anchor$10, {
																	children: ($$anchor$11, $$slotProps$4) => {
																		next();
																		var text_12 = text();
																		template_effect(($0$1) => set_text(text_12, $0$1), [() => label(unit_name())]);
																		append($$anchor$11, text_12);
																	},
																	$$slots: { default: true }
																});
															});
															...
															component(node_29, () => Table_cell, ($$anchor$10, Table_Cell_2) => {
																Table_Cell_2($$anchor$10, {
																	children: ($$anchor$11, $$slotProps$4) => {
																		var span = root_28();
																		var text_13 = child(span, true);
																		reset(span);
																		template_effect(() => set_text(text_13, symbol()));
															...
															component(node_30, () => Table_cell, ($$anchor$10, Table_Cell_3) => {
																Table_Cell_3($$anchor$10, {
																	children: ($$anchor$11, $$slotProps$4) => {
																		{
																			let $0$1 = user_derived(() => cn(displayed() ? "text-green-500" : "text-gray-500"));
																			Button($$anchor$11, {
																				onclick: () => toggle_unit(id()),
																				variant: "ghost",
																				size: "sm",
																				get class() {
																					return get($0$1);
			...
			children: ($$anchor$2, $$slotProps) => {
				...
				Button(node_39, {
					...
					children: ($$anchor$3, $$slotProps$1) => {
						...
						template_effect(($0) => set_text(text_14, ` ${$0 ?? ""}`), [() => _("Add a new unit")]);
