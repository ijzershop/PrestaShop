...
function load(\DynamicProduct $module)
{
    ...
    return [
        'items' => DynamicCondition::getByProduct($id_product),
    ];
}
...
class Actions
{
    ...
    public static function add_single_step()
    {
        ...
        $obj->type = DynamicCalculationItem::CONDITION_ITEM;
        $obj->id_item = 0;
        $obj->save();
    ...
    public static function add_all()
    {
        ...
        foreach ($items as $item) {
            ...
            $calculation_item->type = DynamicCalculationItem::CONDITION_ITEM;
