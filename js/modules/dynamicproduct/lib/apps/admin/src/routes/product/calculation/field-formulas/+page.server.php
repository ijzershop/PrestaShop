...
function load(\DynamicProduct $module)
{
    ...
    return [
        'items' => FieldFormula::getByProduct($id_product),
    ];
}
...
class Actions
{
    ...
    public static function add_single_step()
    {
        ...
        $obj->type = DynamicCalculationItem::FIELD_FORMULA_ITEM;
        $obj->id_item = 0;
        $obj->save();
    ...
    public static function add_all()
    {
        ...
        foreach ($items as $item) {
            ...
            $calculation_item->type = DynamicCalculationItem::FIELD_FORMULA_ITEM;
