          ...
          {if count($field_groups)}
            <table class="table">
              ...
              {foreach from=$field_groups item=field_group}
                  ...
                  {$deletelink = "index.php?controller=AdminModules{$default}&id_field_group={$field_group->id|intval}&submit_delete_field_group&token={$token|escape:'htmlall':'UTF-8'}#field-groups"}
                <tr>
                  <td data-testid="label-cell">{$field_group->label|escape:'htmlall':'UTF-8'}</td>
                  <td data-testid="name-cell">{$field_group->name|escape:'htmlall':'UTF-8'}</td>
                  <td class="text-right">
