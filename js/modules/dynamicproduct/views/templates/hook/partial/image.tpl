      ...
      {foreach from=$input_field->data_obj item=upload}
          {if !$is_pdf}
            ...
            >
              ...
              {if !$is_order_detail}
                <div
                        class="modal fade" id="dp_modal_{$target|escape:'htmlall':'UTF-8'}" tabindex="-1" role="dialog"
                        aria-hidden="true"
                >
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <!-- And in the front office, we displayed it afterward -->
                          ...
                          {/if}
                        <button
                                type="button" class="btn-close" data-dismiss="modal" data-bs-dismiss="modal"
                                aria-label="Close">
                        </button>
                          {if !isset($is_admin) || !$is_admin}
                            <h5 class="modal-title">{$input_field->label|escape:'htmlall':'UTF-8'}</h5>
                      ...
                      <div class="modal-body">
                        <img
                                src="{$input_field->getFileUrl($upload.file)|escape:'htmlall':'UTF-8'}"
                                style="width: 100%;"
                                alt="preview"
                        >
                      </div>
