...
class MollieLogger
{
    ...
    public function logPaymentMessage($message, string $level = 'info', bool $withEmail = true, int $code = 200): void
    {
        ...
        $debugMode = Configuration::get('MSMOLLIE_DEBUG_MODE', null, $shopGroupId, $shopId);
        ...
        try {
            ...
            if($withEmail){
                $emailTo = Configuration::get('MSMOLLIE_EMAIL', $langId, $shopId, $shopGroupId, 'jelmer@ijzershop.nl');
