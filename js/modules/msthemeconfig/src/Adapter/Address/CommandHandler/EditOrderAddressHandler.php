...
class EditOrderAddressHandler
{
     ...
     * @return AddressId
     */
    public function __invoke(EditOrderAddressCommand $command): AddressId
    {
    ...
    private function createEditAddressCommand(EditOrderAddressCommand $orderCommand): EditCustomerAddressCommand
    {
        ...
        if (null !== $orderCommand->getHouseNumber()) {
            $addressCommand->house_number = $orderCommand->getHouseNumber();
        }

        if (null !== $orderCommand->getHouseNumberExtension()) {
            $addressCommand->house_number_extension = $orderCommand->getHouseNumberExtension();
        }
