 ...
 */
namespace MsThemeConfig\Adapter\Customer\QueryHandler;

use MsThemeConfig\Core\Domain\Customer\Query\GetCustomerForEditing;
use PrestaShop\PrestaShop\Adapter\Entity\Customer;
use PrestaShop\PrestaShop\Core\Domain\Customer\Exception\CustomerNotFoundException;
use MsThemeConfig\Core\Domain\Customer\QueryHandler\GetCustomerForEditingHandlerInterface;
...
final class GetCustomerForEditingHandler implements GetCustomerForEditingHandlerInterface
{
     ...
     */
    public function __invoke(GetCustomerForEditing $query)
    {
    ...
    public function handle(GetCustomerForEditing $query)
    {
        ...
        return new EditableCustomer(
            ...
            (int) $customer->informer_identification,
