...
class ExportOrders
{
    ...
    {
        $carrierId = \Carrier::resolveCarrierIdFromConfig((int) Configuration::get('KOOPMANORDEREXPORT_SELECT_CARRIER', $this->idLang, $this->idShopGroup, $this->idShop));
        $orders = $this->_getOrders(
            Configuration::get('KOOPMANORDEREXPORT_SELECT_STATUS', $this->idLang, $this->idShopGroup, $this->idShop),
            $carrierId,
            1,
            $this->id_order
        );
    ...
    */
    ...
    public function dagafsluiting()
    {
        ...
        if (Configuration::get('KOOPMANORDEREXPORT_UPDATE_BOOL', $this->idLang, $this->idShopGroup, $this->idShop) && is_numeric(Configuration::get('KOOPMANORDEREXPORT_UPDATE_STATUS', $this->idLang, $this->idShopGroup, $this->idShop))) {
            ...
            $carrierId = \Carrier::resolveCarrierIdFromConfig((int) Configuration::get('KOOPMANORDEREXPORT_SELECT_CARRIER', $this->idLang, $this->idShopGroup, $this->idShop));
            $orders = $this->_getOrders(
                Configuration::get('KOOPMANORDEREXPORT_UPDATE_STATUS', $this->idLang, $this->idShopGroup, $this->idShop),
                $carrierId
            );
