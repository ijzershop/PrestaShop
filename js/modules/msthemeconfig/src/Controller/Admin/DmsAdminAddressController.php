...
/**
 * Class DmsAdminAddressController
 */
class DmsAdminAddressController extends PrestaShopAdminController
{
    /**
     * Show "Add new" form and handle form submit.
     *
     * @param Request $request
     * @param FormBuilderInterface $addressFormBuilder
     * @param FormHandlerInterface $addressFormHandler
    ...
    public function createAction(
        Request $request,
        #[Autowire(service: 'modernesmid.core.form.identifiable_object.builder.address_form_builder')]
        FormBuilderInterface $addressFormBuilder,
        #[Autowire(service: 'modernesmid.core.form.identifiable_object.handler.address_form_handler')]
    ...
    public function editAction(
        ...
        try {
            ...
            $editableAddress = $commandBus->handle(new GetCustomerAddressForEditing((int) $addressId));
    ...
    public function editOrderAddressAction(
        ...
        #[Autowire(service: 'modernesmid.core.form.identifiable_object.builder.address_form_builder')]
        FormBuilderInterface $addressFormBuilder,
        #[Autowire(service: 'modernesmid.core.form.identifiable_object.handler.order_address_form_handler')]
        FormHandlerInterface $addressFormHandler,
        #[Autowire(service: 'prestashop.core.command_bus')]
        CommandBusInterface $commandBus
    ): Response {
     ...
     * @param GridFactoryInterface $addressGridFactory
     *
     * @return Response
     */
    ...
    public function indexAction(
        ...
        if ($request->getMethod() == 'POST') {
            $filter = $request->request->all('address');
        ...
        $requiredFieldsForm = $this->getRequiredFieldsForm($commandBus);
    ...
    {
        $requiredFields = $commandBus->handle(new GetRequiredFieldsForAddress());
