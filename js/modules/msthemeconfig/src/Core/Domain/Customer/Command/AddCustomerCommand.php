...
namespace MsThemeConfig\Core\Domain\Customer\Command;
...
class AddCustomerCommand
{
     ...
     * @var int|null
     */
    private ?int $informerIdentification;
     ...
     * @param int|null $informerIdentification
     * @param bool $isGuest
     */
    public function __construct(
        ...
        $this->informerIdentification = $informerIdentification;
     ...
     * @return int|null
     */
    public function getInformerIdentification()
    {
        return $this->informerIdentification;
    }

    /**
     * @param int|null $informerId
     *
     * @return self
     */
    public function setInformerIdentification($informerId)
    {
        $this->informerIdentification = $informerId;
