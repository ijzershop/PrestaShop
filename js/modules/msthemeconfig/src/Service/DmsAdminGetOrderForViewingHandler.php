 ...
 * @internal
 */
final class DmsAdminGetOrderForViewingHandler extends AbstractOrderHandler implements GetOrderForViewingHandlerInterface
{
    /**
     * @var Locale
     */
     ...
     */
    public function __invoke(GetOrderForViewing $query): OrderForViewing
    {
...
//            $order->id_address_delivery = $failingAddressId;
//            $order->update();
