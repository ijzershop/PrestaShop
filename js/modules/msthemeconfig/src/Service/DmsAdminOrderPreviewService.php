...
/**
 * Handles GetOrderPreview query using custom logic
 */
#[AsQueryHandler]
final class DmsAdminOrderPreviewService implements GetOrderPreviewHandlerInterface
{
    ...
    public function __invoke(GetOrderPreview $query): OrderPreview
    {
    ...
    public function displayAdminInputSummary($id_input)
    {
        ...
        return $smarty->fetch(_PS_ROOT_DIR_ . '/modules/dynamicproduct/views/templates/hook/display-admin-input-summary.tpl');
    }
}
