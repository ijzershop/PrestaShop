...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-sd-12 text-right" style="margin-top: 0.5em;">
        <a href="{$maillink}" class="btn btn-success">
            <span class="icon-send"> </span>&nbsp; Verstuur offerte per email
        </a>
    </div>
</div>
