...
<div class="card mt-3" id="offer_card_access">
  ...
  <div class="mt-3 d-none" id="offer_card">
    <div id="js-product-list-header" class="col-12 pr-3 pl-3  pr-lg-0 pl-lg-0 ">
        ...
        <div class="col-12">
          <div id="category-description" class="text-muted table-responsive">
            <table class="table table-condensed table-striped table-hover w-100">
              ...
              <tr>
                <th class="col-auto">Aanbod op</th>
              ...
              <tr>
                <th>Bericht</th>
                <td>
                  {$offer.message|html_entity_decode nofilter}
                </td>
              </tr>
              {/if}
            </table>
      ...
      <div class="row text-center"><a href="#" class="w-100 h5 text-decoration-none" id="toggle-cat-description" data-shown="0" onclick="toggleCategoryDescr(this)"> <i class="fasl fa-chevron-down"></i>  <span>Toon meer informatie</span>  <i class="fasl fa-chevron-down"></i> </a></div>
    </div>
    ...
    <div class="w-100 mt-3">
      <div class="col-12 p-4 bg-info">
        {include file='themes/modernesmid/templates/custom_blocks/category_footer.tpl'}
      </div>
    </div>
    </div>
    ...
    <script type="text/javascript">
      function toggleCategoryDescr(e){
        if(document.getElementById('block-category-inner').classList.contains('active')){
          ...
          document.getElementById('category-description').classList.add('text-muted');
          ...
          document.getElementById('category-description').classList.remove('text-muted');
