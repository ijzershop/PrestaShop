...
{*                <div class="">*}
{*                    <h4 class="modal-title" id="staffelLabel-{$product->id}">{$product->name|escape:'html':'UTF-8'}</h4>*}
{*                </div>*}
...
{*                  <div class="row">*}
{*                    <div class="col-sm-12">*}
{*                      <p>Koop <strong>{$product->name|escape:'html':'UTF-8'}</strong> in bulk voor staffelkorting.</p>*}
{*                    </div>*}
{*                  </div>*}
{*                  <div class="row">*}
{*                    <div class="col-sm-12">*}
...
{*                          <td>&euro; {$staffelprice_formatted} incl. btw</td>*}
...
{*                                    <span class="subtotal-inc-price">&euro; {$price_incl_formatted}</span>*}
{*                                </div>*}
{*                            </td>*}
{*                        </tr>*}
...
{*                                   <span class="subtotal-inc-price">&euro; {$zero_price_formatted}</span>*}
{*                                </div>*}
{*                            </td>*}
{*                        </tr>*}
{*                        <tr>*}
...
{*                                    <span class="subtotal-inc-price">&euro; {$price_excl_formatted}</span>*}
{*                                </div>*}
{*                            </td>*}
{*                        </tr>*}
{*                        <tr>*}
