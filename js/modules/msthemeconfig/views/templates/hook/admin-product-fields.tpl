<div class="mb-3">
    ...
    <h2>{l s='Zagen' mod='msthemeconfig'}</h2>
    <fieldset class="form-group mb-0">
        <label class="form-control-label">{l s='Saw Loss' mod='msthemeconfig'}</label>
    {if $saw_loss|is_null || $saw_loss == 0}
    ...
    <fieldset class="form-group mb-0">
        <label class="form-control-label">{l s='Minimum Saw Size' mod='msthemeconfig'}</label>
    {if $min_saw_size|is_null || $min_saw_size == 0}
    ...
    <h2>{l s='Knippen' mod='msthemeconfig'}</h2>
    <fieldset class="form-group mb-0">
        <label class="form-control-label">{l s='Minimum Cut Size' mod='msthemeconfig'}</label>
    {if $min_cut_size|is_null || $min_cut_size == 0}
    ...
    <fieldset class="form-group mb-0">
        <label class="form-control-label">{l s='Minimum Cut Remainder' mod='msthemeconfig'}</label>
    {if $min_cut_remainder|is_null || $min_cut_remainder == 0}
    ...
    <h2>{l s='Knip en Zaag kosten' mod='msthemeconfig'}</h2>
    <fieldset class="form-group mb-0">
        <label class="form-control-label">{l s='Default cut price' mod='msthemeconfig'}</label>
