...
public function addOrderState($name)
    ...
    protected function _postProcess()
    {
        if (Tools::isSubmit('btnSubmit')) {
            ...
            Configuration::updateValue('BANK_PIN_CUSTOM_TEXT', $custom_text);
    ...
    public function getConfigFieldsValues()
    {
        ...
        foreach ($languages as $lang) {
            $custom_text[$lang['id_lang']] = Tools::getValue(
                ...
                Configuration::get('BANK_PIN_CUSTOM_TEXT', $lang['id_lang'], Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id)
            );
        }
    ...
    public function getTemplateVarInfos()
    {
        ...
        $bankpinCustomText = Tools::nl2br(Configuration::get('BANK_PIN_CUSTOM_TEXT', $this->context->language->id, $this->context->shop->id_shop_group, $this->context->shop->id));
