...
<section>
  <p>
    {if $bankpinCustomText }
        <a data-bs-toggle="modal" data-bs-target="#bankpin-modal">{l s='More information' d='Modules.Pinpayment.Shop'}</a>
    {/if}
  </p>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title">{l s='Bankpin' d='Modules.Pinpayment.Shop'}</h2>
