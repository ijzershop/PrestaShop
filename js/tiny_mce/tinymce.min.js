...
!function (j) {
  ...
  var et, tt, nt, rt, ot = function (e) {
      ...
      }, nu: ft, edge: $("Edge"), chrome: $("Chrome"), ie: $("IE"), opera: $("Opera"), firefox: $(lt), safari: $("Safari")
    ...
    }, {name: "Opera", versionRegexes: [xt, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: le("opera")}, {
      name: "Firefox",
    ...
    }], Et = [{name: "Windows", search: le("win"), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/]}, {
      name: "iOS",
      search: function (e) {
      ...
      var n = Nt.browsers(), r = Nt.oses(), o = Ct(n, e).fold(dt.unknown, dt.nu), i = wt(r, e).fold(bt.unknown, bt.nu);
      return {
  ...
  et = undefined, tt = on, nt = an, rt = undefined, function (e) {
    ...
    return function l(i, a, u) {
      ...
      1: [function (e, t, n) {
        ...
        (function (e, t) {
          var r = c("process/browser.js").nextTick, n = Function.prototype.apply, o = Array.prototype.slice, i = {},
            a = 0;
  ...
  for (Qr in eo = Jo.support = {}, ro = Jo.isXML = function (e) {
    ...
    var n = to.attrHandle[t.toLowerCase()], r = n && ko.call(to.attrHandle, t.toLowerCase()) ? n(e, t, !mo) : undefined;
  ...
  }).pseudos.nth = to.pseudos.eq, {radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) to.pseudos[Qr] = ni(Qr);
  ...
  var xi = j.document, zi = Array.prototype.push, Ei = Array.prototype.slice,
    ...
    Ri = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, _i = {"float": "cssFloat"}, Di = {}, Oi = {},
    Hi = /^\s*|\s*$/g, Bi = function (e) {
  ...
  var Al, Ml = Qt.isContentEditableFalse, Rl = Qt.isText, _l = Qt.isElement, Dl = Qt.isBr, Ol = qa, Hl = function (e) {
  ...
  function vf(q, $) {
    ...
    var W = q.comment ? q.comment : e, K = q.cdata ? q.cdata : e, X = q.text ? q.text : e, Y = q.start ? q.start : e,
      G = q.end ? q.end : e, Z = q.pi ? q.pi : e, J = q.doctype ? q.doctype : e;
    return {
      parse: function (i, e) {
        void 0 === e && (e = "html");
        ...
        var o, u, c, s, l, f, d, h, m, g, p, v, y, b, C, w, x, z, E, N, S, k, T, A, M, R, _, D, O, H = 0, B = [], P = 0,
          L = Sr.decode, V = Zn.makeMap("src,href,data,background,formaction,poster,xlink:href"),
  ...
  function ah(e) {
    e.contentCSS = e.contentCSS.concat(function (t) {
      var e = Ms(t), n = t.editorManager.baseURL + "/skins/content", r = "content" + t.editorManager.suffix + ".css",
        o = !0 === t.inline;
      return X(e, function (e) {
        return function (e) {
  ...
  function lh(r, a) {
    ...
    var H = function () {
      ...
      P(), L(), t = z.getPos(e, A), m = t.x, g = t.y, i = e.getBoundingClientRect(), r = i.width || i.right - i.left, o = i.height || i.bottom - i.top, u !== e && (u = e, b = C = 0), n = a.fire("ObjectSelected", {target: e}), _(e) && !n.isDefaultPrevented() ? E(l, function (t, e) {
        ...
        }), t.elm = n, z.setStyles(n, {left: r * t[0] + m - n.offsetWidth / 2, top: o * t[1] + g - n.offsetHeight / 2})
  ...
  function yh(e, t) {
    var n = function (e) {
      ...
      var i = Pe(r.pageYOffset, o.scrollTop), a = Pe(r.pageXOffset, o.scrollLeft), u = Pe(o.clientTop, n.clientTop),
  ...
  function $m(T, A) {
    ...
    return function (e, g) {
      ...
      g.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
        var r, o, i, a, u, c, s, l, f = e.length, d = Zn.extend({}, p.getBlockElements()), h = p.getNonEmptyElements(),
  ...
  var Mw = d(tb, Wu.isAbove, -1), Rw = d(tb, Wu.isBelow, 1), _w = d(nb, -1, Mw), Dw = d(nb, 1, Rw),
    Ow = Qt.isContentEditableFalse, Hw = Ja, Bw = d(fb, function (e) {
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() && function (e, t, n) {
          ...
          }, {keyCode: hh.LEFT, ctrlKey: !r.isOSX(), altKey: r.isOSX(), action: by.movePrevWord(e, t)}, {
            keyCode: hh.UP,
            action: Tb(e, !1)
          }, {keyCode: hh.DOWN, action: Tb(e, !0)}], n).each(function (e) {
            n.preventDefault()
          })
        }(t, n, e)
      })
    ...
    Qw = function (e, t) {
      ...
      return function (e, t) {
        ...
        var r = t ? Pc.Forwards : Pc.Backwards, o = Xs(e.getBody()), i = d(Hc, o.next), a = d(Hc, o.prev), u = t ? i : a,
          c = t ? Jy : Qy, s = Dc(r, e.getBody(), n), l = ly.normalizePosition(t, u(s));
      ...
      if (e.selection.isCollapsed() && TC(e)) {
        var r = e.dom, o = e.selection.getRng(), i = Vc.fromRangeStart(o), a = r.getParent(o.startContainer, r.isBlock);
        ...
        D(n.plugins) && (n.plugins = n.plugins.join(" ")), Zn.each(n.external_plugins, function (e, t) {
          ...
          if ((e = Zn.trim(e)) && !Qd.urls[e]) if (oz(e)) {
            ...
            Zn.each(t, function (e) {
              var t = {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"}, n = Qd.createUrl(t, e);
  ...
  var Ez = function (e, t) {
    ...
    if (e = Zn.trim(e), r && -1 === Zn.inArray(n, e)) {
      ...
      try {
        var i = new r(t, o, t.$);
        viewProduct.init && (viewProduct.init(t, o), n.push(e))
      } catch (HN) {
    ...
    e.fire("ScriptsLoaded"), function (n) {
      ...
      if (K(t)) {
        ...
        var n = eh.get(t);
        e.theme = new n(e, eh.urls[t]), viewProduct.init && viewProduct.init(e, eh.urls[t] || e.documentBaseUrl.replace(/\/$/, ""), e.$)
      } else e.theme = {}
    }(e), function (t) {
      var n = [];
    ...
    var n = function (e) {
      var t;
      return "string" != typeof e ? (t = Zn.extend({paste: e.paste, data: {paste: e.paste}}, e), {
        content: e.content,
        details: t
      }) : {content: e, details: {}}
    }(t);
    ...
    this.addCommands({
      "mceResetDesignMode,mceBeginUndoLevel": function () {
        ...
        if ("paste" !== e || n.queryCommandEnabled(e) || (t = !0), t || !n.queryCommandSupported(e)) {
          ...
          Wn.mac && (r = r.replace(/Ctrl\+/g, "\u2318+")), i.notificationManager.open({text: r, type: "error"})
        }
      }, unlink: function () {
  ...
  var HE = Qi.DOM, BE = Zn.extend, PE = Zn.each, LE = Zn.resolve, VE = Wn.ie, IE = (FE.prototype.render = function () {
    Iz(this)
  ...
  iN.extend = cN = function (n) {
    function r() {
      var e, t, n;
      if (!sN && (viewProduct.init && viewProduct.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) viewProduct.init && viewProduct.init.apply(this, arguments)
    }
  ...
  var _N, DN = {
    ...
    html: {Styles: $r, Entities: Sr, Node: hf, Schema: Pr, SaxParser: fd, DomParser: $m, Writer: Cf, Serializer: wf},
    Env: Wn,
    AddOnManager: wa,
    Annotator: uf,
    Formatter: Wp,
