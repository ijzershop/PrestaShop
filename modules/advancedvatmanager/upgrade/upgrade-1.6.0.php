...
function upgrade_module_1_6_0($module)
{
    ...
    Configuration::updateValue('ADVANCEDVATMANAGER_COUNTRY', $module->getCountriesID());     
    ...
    include(_PS_MODULE_DIR_.'/advancedvatmanager/sql/install_no.php');// Install Norwegian states
    
    //Modify database tables
    $sql = array(
    'ALTER TABLE `' . _DB_PREFIX_ . 'advancedvatmanager_orders` ADD COLUMN `voec` TINYINT(1) DEFAULT 0 AFTER `brexit`');
