...
<div class="panel">
    <h3>
        ...
        {else}
            ...
            {if !empty($message.id_customer)}
                <a href="index.php?tab=AdminCustomers&amp;id_customer={$message.id_customer}&amp;viewcustomer&amp;token={$message.token}" title="{l s='View customer' d='Admin.Orderscustomers.Feature'}">
    ...
    <div class="infoCustomer">
        ...
        {if !empty($message.file_name) && $file_name}
            <dl class="dl-horizontal">
                ...
                <dd>
                    <a href="index.php?tab=AdminCustomerThreads&amp;id_customer_thread={$message.id_customer_thread}&amp;viewcustomer_thread&amp;token={$message.token}&amp;filename={$message.file_name}"
        ...
        {if !empty($message.id_order) && $is_valid_order_id && empty($message.id_employee)}
            <dl class="dl-horizontal">
                ...
                <dd><a href="index.php?tab=AdminOrders&amp;id_order={$message.id_order}&amp;vieworder&amp;token={$message.token}" title="{l s='View order' d='Admin.Orderscustomers.Feature'}">{$message.id_order} <img src="../img/admin/search.gif" alt="{l s='View' d='Admin.Actions'}" /></a>
                </dd>
            </dl>
        {/if}
    ...
    <div id="reply_to_{$message.id_customer_message}" style="display: none;">
        <div class="panel">
            <form action="{$current|escape:'html':'UTF-8'}&amp;token={$message.token}&amp;id_customer_thread={$message.id_customer_thread|intval}&amp;viewcustomer_thread=1" method="post" enctype="multipart/form-data" class="form-horizontal">
