    ...
    <form action="{$req|escape:'htmlall':'UTF-8'}" method="post" id="dp_field_groups_form">
        <div class="panel">
                            ...
                            <td class="text-right">
                                <div class="btn-group-action">
                                    <div class="btn-group pull-right">
                                        <a href="{$editlink|escape:'htmlall':'UTF-8'}" data-cy="edit-button" title="{l s='Edit' mod='dynamicproduct'}" class="edit btn btn-default">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="{$deletelink|escape:'htmlall':'UTF-8'}" data-cy="delete-button" title="{l s='Delete' mod='dynamicproduct'}" class="dp_confirm_delete">
            ...
            <div class="panel-footer">
                <a class="btn btn-default pull-right" data-cy="add-field-group" href="{$dp_module_link|escape:'htmlall':'UTF-8'}&display_add_field_group">
