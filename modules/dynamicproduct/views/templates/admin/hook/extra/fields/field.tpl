...
<tr id="dp_row_{$field->id|intval}"
    ...
    class="{if $field->favorite}dp_favorite_field{/if} {if $field->common}dp_common_field{/if} {if $field->linked}dp_linked_field{/if} {if $field->id==0}dp_field_clone{/if}"
>
  <td class="dp_fav">
      {if !$field->linked}
  ...
  <td><input data-name="name" placeholder="{l s='field_name' mod='dynamicproduct'}" data-type="plain" value="{$field->name|escape:'htmlall':'UTF-8'}" type="text" class="form-control"/></td>
  <td class="dp_lang_column">
    <div class="dp_group dp_input_lang" data-id_field="{$field->id|intval}" data-class="field">
      <div class="dp_lang_container">
          {foreach from=$dp_languages item=lang}
            <div class="dp_lang">
              <input placeholder="{l s='Label' mod='dynamicproduct'}" type="text" value="{if isset($field->label[$lang.id_lang])}{$field->label[$lang.id_lang]|escape:'htmlall':'UTF-8'}{/if}" data-name="label" data-id_lang="{$lang.id_lang|intval}" class="dp_lang_input form-control">
