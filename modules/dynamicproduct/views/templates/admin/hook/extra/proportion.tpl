...
<div class="row dp_proportion dp_proportion_{$proportion->id|intval}">
    <div class="col-lg-8">
    ...
    <div class="col-lg-2">
        <button class="btn btn-success dp_proportions_save">{l s='Save' mod='dynamicproduct'}</button>
        <button class="btn btn-danger dp_proportions_delete" data-id_proportion="{$proportion->id|intval}"><i class="icon-remove"></i></button>
    </div>
</div>
