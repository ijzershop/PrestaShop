...
<div id="dp_weight_equation"  class="dp_dynamicproduct_equation dp_formula_bloc">
    <div class="dp_formula_container dp_equation_container" data-id_attribute="0">
        <label class="dp_main_label">{l s='Weight Formula' mod='dynamicproduct'}:</label>
        <span class="dp_equation_error"></span>
        <textarea class="dp_equation_content" id="dp_equation_1" data-tab_name="weight_formula"></textarea>
