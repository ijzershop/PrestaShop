...
class categoryTag extends baseTag
{
    ...
    public function __construct(array $aParams)
    {
        ...
        $this->oCategoryName = moduleTools::getCategoryName((int) $this->iCategoryId, \GAnalyticsPro::$iCurrentLang);
    ...
    {
        $this->sContent_name = str_replace(['\'', '"'], ' ', $this->oCategoryName);
    }
    ...
    {
        $this->sContent_Category = parent::$sQuote . str_replace(['\'', '"'], ' ', html_entity_decode(moduleTools::getCategoryName($this->iCategoryId, \GAnalyticsPro::$iCurrentLang))) . parent::$sQuote;
    }
