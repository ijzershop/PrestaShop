...
<div class="bootstrap">
    <form class="form-horizontal col-lg-12" action="{$sURI|escape:'htmlall':'UTF-8'}" method="post" id="bt_advanced-form" name="bt_advanced-form" onsubmit="javascript: oGap.form('bt_advanced-form', '{$sURI|escape:'htmlall':'UTF-8'}', null, 'bt_advanced-settings', 'bt_advanced-settings', false, false, null, 'advanced', 'advanced');return false;">
        ...
        {if empty($sDisplay) || (!empty($sDisplay) && $sDisplay == 'advanced')}
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-12 col-md-5 col-lg-4" for="bt_order-statuses">
                    ...
                    <table cellspacing="0" cellpadding="0" class="table table-responsive table-bordered table-striped">
                        {foreach from=$aOrderStatusTitle key=id item=aOrder}
                            <tr>
                                ...
                                <td>
                                    <label for="bt_order-status">{$aOrder.name|escape:'htmlall':'UTF-8'}</label>
                                </td>
                            </tr>
                        {/foreach}
                    </table>
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-12 col-md-5 col-lg-4" for="bt_order-status_partial_refund">
                    ...
                    <table cellspacing="0" cellpadding="0" class="table table-responsive table-bordered table-striped">
                        {foreach from=$aOrderStatusTitle key=id item=aOrder}
                            <tr>
                                ...
                                <td>
                                    <label for="bt_order-status_partial_refund">{$aOrder.name|escape:'htmlall':'UTF-8'}</label>
                                </td>
                            </tr>
                        {/foreach}
                    </table>
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-md-3 col-lg-4">
                    <b>{l s='Deduct the amount of discounts' mod='ganalyticspro'}</b> :
                </label>
                <div class="col-xs-12 col-md-5 col-lg-6">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="bt_deduct_discount" id="bt_deduct_discount_on" value="1" {if !empty($bDeductDiscount)}checked="checked" {/if} />
                        <label for="bt_deduct_discount_on" class="radioCheck">
                            {l s='Yes' mod='ganalyticspro'}
                        </label>
                        <input type="radio" name="bt_deduct_discount" id="bt_deduct_discount_off" value="0" {if empty($bDeductDiscount)}checked="checked" {/if} />
                        <label for="bt_deduct_discount_off" class="radioCheck">
                            {l s='No' mod='ganalyticspro'}
                        </label>
                        <a class="slide-button btn"></a>
                    </span>
        ...
        <div class="center">
            <div class="row">
                <div class="navbar navbar-default navbar-fixed-bottom text-center">
                    <button class="btn btn_submit" onclick="oGap.form('bt_advanced-form', '{$sURI|escape:'htmlall':'UTF-8'}', null, 'bt_advanced-settings', 'bt_advanced-settings', false, false, null, 'advanced', 'advanced');return false;">{l s='Save' mod='ganalyticspro'}</button>
                </div>
            </div>
        </div>
