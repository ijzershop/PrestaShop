...
<div class="dropdown" style="margin-bottom: 20px">
    ...
    <div class="dropdown-menu">
        {foreach $idealIssuers as $issuer}
            <a class="dropdown-item mollie-issuer-item" data-ideal-issuer="{$issuer['id']|escape:'htmlall':'UTF-8'}"
               style="cursor: pointer">
                <img src="{$issuer['image']['size2x']|escape:'htmlall':'UTF-8'}"
                     style="height: 24px; width: auto;"> {$issuer['name']|escape:'htmlall':'UTF-8'}
            </a>
        {/foreach}
    </div>
</div>
