...
class ExportOrders
{
    ...
    public function __construct($configuration)
    {
        ...
        $this->labels_folder = str_replace('private_html', 'public_html',
            $_SERVER['DOCUMENT_ROOT'] . '/upload/' . $this->configuration['labels_folder']);
    }
    ...
    {
        $lane_1 = (int)$this->configuration['select_packagelane_1_profile'];
        $lane_2 = (int)$this->configuration['select_packagelane_2_profile'];
        $lane_3 = (int)$this->configuration['select_packagelane_3_profile'];
...
//            Verzender gegevens
            ...
            $opdracht->afznaam = $this->configuration['koopman_afzendernaam'];
            $opdracht->afznaam2 = $this->configuration['koopman_afzendernaam2'];
            $opdracht->afzastraat = $this->configuration['koopman_afzenderstraat'];
            $opdracht->afzhuisnr = $this->configuration['koopman_afzenderhuisnr'];
            $opdracht->afzpostcode = $this->configuration['koopman_afzenderpostcode'];
            $opdracht->afzplaats = $this->configuration['koopman_afzenderplaats'];
            $opdracht->afzland = $this->configuration['koopman_afzenderland'];
//            Klant gegevens
