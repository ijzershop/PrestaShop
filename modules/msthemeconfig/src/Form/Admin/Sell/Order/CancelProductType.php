...
namespace MsThemeConfig\Form\Admin\Sell\Order;
        ...
        $builder
            ...
            ->add('voucher_refund_type', ChoiceType::class,
                [
                    ...
                    'expanded' => true,
                    'choices' => [
                        $this->trans('Totaalbedrag:', 'Admin.Orderscustomers.Feature') => VoucherRefundType::PRODUCT_PRICES_REFUND,
                        $this->trans('Totaalbedrag (minus de verleende voucherkorting):', 'Admin.Orderscustomers.Feature') => VoucherRefundType::PRODUCT_PRICES_EXCLUDING_VOUCHER_REFUND,
                    ],
