...
<div id="kiyoh-block" class="text-decoration-none text-dark d-flex">
  <ul class="list-group mx-auto">
    ...
    <li class="list-group-item border-0 p-0 slide_hidden"><a target="_blank" href="https://www.kiyoh.com/reviews/1046584/ijzershop" title="{l s='98% adviseert de IJzershop!, lees hier onze reviews' d='Modules.Ijzershopkiyoh.kiyoh-score-header-block'}"><span class="icon"><i class="pr-2 fasl fa-star d-inline-flex"></i></span><span class="text">Wij krijgen {str_replace('.',',', $attr['averageRating'])}/10 van {$attr['totalReviews']} klanten</span></a></li>
    <li class="list-group-item border-0 p-0 slide_hidden"><a href="{$attr['shippingPage']|escape:'html'}" title="{l s='Verzonden met 1 werkdag, lees hier over onze verzending' d='Modules.Ijzershopkiyoh.kiyoh-score-header-block'}"><span class="icon"><i class="pr-2 fasl fa-truck-fast d-inline-flex"></i></span><span class="text">Verzonden met <b>1 werkdag</b> voor <b> {number_format(Tools::convertPrice($defaultShippingPrice*1.21),0,',','.')},-</b></span></a></li>
  </ul>
</div>
