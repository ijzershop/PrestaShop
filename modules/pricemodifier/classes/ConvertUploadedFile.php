...
//                    print("<pre>" . print_r($data, true) . "</pre>");
    ...
    {
        return $this->readFile('C:\xampp\htdocs\ijzershop.local\modules\modernesmid_price_modifier\uploads\Douma-prijslijst-2022-03-08.xls',
            'DOUMA');
    }
    ...
    private function createXlsFile($data_array, $supplier_name)
    {
        ...
        $spreadsheet->getStyle('A1:' . $highestColumn . '1' )->applyFromArray($styleArrayFirstRow);
