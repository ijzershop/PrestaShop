            ...
            .done(function(e) {
                ...
                for (var i = 0; i < e.result.length; i++) {
                    ...
                    if (comment.customer_advice !== undefined && parseInt(comment.customer_advice) === 0 && loggedIn) {
                        advice_buttons = `
                                        <li>Was deze beoordeling handig voor u?
                    ...
                    if (!parseInt(comment.customer_report)) {
                        ...
                        report_abuse = `<li><span class="report_btn" data-id-product-comment="${comment.id_product_comment}">Raporteer deze opmerking</span></li>`;
                    }
