...
<section>
  ...
  <div class="input-group mb-3">
    <div class="input-group-prepend">
      <span class="input-group-text" id="customer-selection"><i class="fasl fa-user"></i></span>
    </div>
  ...
  <div class="input-group mb-3">
    <div class="input-group-prepend">
      <span class="input-group-text" for="on_credit_reference"><i class="fasl fa-barcode"></i></span>
    </div>
  ...
  <div class="input-group mb-3">
    <div class="input-group-prepend">
      <span class="input-group-text" for="on_credit_buyer"><i class="fasl fa-user-tie"></i></span>
    </div>
