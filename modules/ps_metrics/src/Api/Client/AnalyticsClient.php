...
class AnalyticsClient
{
     ...
     * @return void
     */
    public function __construct(AnalyticsEnv $analyticsEnv, JsonHelper $jsonHelper)
    {
    ...
    public function create()
    {
        $this->client = new Client([
            'base_url' => $this->analyticsEnv->getServiceUrl(),
            'defaults' => [
                'timeout' => 10,
                'exceptions' => false,
                'headers' => [
    ...
    protected function post($options = [])
    {
        ...
        $responseContents = $this->jsonHelper->jsonDecode($response->getBody()->getContents(), true);
