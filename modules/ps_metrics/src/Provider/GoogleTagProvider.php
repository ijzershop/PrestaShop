...
class GoogleTagProvider
{
    ...
    /**
     * @var RetrieveShopSource
     */
    private $retrieveShopSource;

    /**
     * __construct
     *
     * @param RetrieveShopSource $retrieveShopSource
     */
    public function __construct(RetrieveShopSource $retrieveShopSource)
    {
        $this->retrieveShopSource = $retrieveShopSource;
    }
    ...
    {
        $this->retrieveShopSource->create($baseUrl);
        $this->shopSource = $this->retrieveShopSource->getSourcePage();
    }
