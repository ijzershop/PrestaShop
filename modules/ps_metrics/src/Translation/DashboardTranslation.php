        ...
        $translations[$locale] = [
            ...
            'tabsBody' => [
                ...
                'conversionRate' => [
                    ...
                    'customer_with_orders_text' => $this->module->l('{valueCustomers}{typeValueCustomers} customers who already have completed an order represents {valueRevenues}{typeValueRevenues} of CA', 'DashboardTranslation'),
                    'customer_without_orders_text' => $this->module->l('{valueCustomers}{typeValueCustomers} customers who have bought for the first time represents {valueRevenues}{typeValueRevenues} of CA', 'DashboardTranslation'),
                ],
                'nextFeatures' => [
