<form action="{$action}" id="payment-form" class="additional-information">
		<div class="form-group row">
			...
			<div class="col-md-6">
				<select class="form-control form-control-select" name="billink_gender" id="billink_gender" required>
		...
		<div class="form-group row">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" autocomplete="off" id="billink_phone" name="billink_phone" required="required">
			</div> 
		</div> 
		...
		<div class="form-group row">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="col-md-4">
						<select class="form-control form-control-select" name="billink_day" id="billink_day" required>
					...
					<div class="col-md-4">
						<select class="form-control form-control-select" name="billink_month" id="billink_month" required>
					...
					<div class="col-md-4">
						<select class="form-control form-control-select" name="billink_year" id="billink_year">
		...
		<div class="form-group row">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" autocomplete="off" id="billink_coc" name="billink_coc" required>
				<small>Alleen verplicht bij B2B</small>
			</div> 
		</div> 

	<input type="hidden" name="payment" value="billink"/>
