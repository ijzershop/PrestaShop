<form action="{$action}" id="payment-form" class="additional-information">
		<div class="form-group row">
			...
			<div class="col-md-6">
				<select class="form-control form-control-select" name="focum_gender" id="focum_gender" required>
		...
		<div class="form-group row">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" autocomplete="off" id="focum_phone" name="focum_phone" required="required">
			</div> 
		</div> 
		...
		<div class="form-group row">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" autocomplete="off" id="focum_iban" name="focum_iban" required>
			</div> 
		</div> 
		...
		<div class="form-group row">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="col-md-4">
						<select class="form-control form-control-select" name="focum_day" id="focum_day" required>
					...
					<div class="col-md-4">
						<select class="form-control form-control-select" name="focum_month" id="focum_month" required>
					...
					<div class="col-md-4">
						<select class="form-control form-control-select" name="focum_year" id="focum_year">
	...
	<input type="hidden" name="payment" value="focum"/>
