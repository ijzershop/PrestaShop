        ...
        foreach ($ca['payment'] as $payment) {
            $this->html .= '
						<tr>
							...
							<td class="text-right">'.$this->context->getCurrentLocale()->formatPrice((float)$payment['total'], $currency->iso_code).'</td>
							<td class="text-right">'.$this->context->getCurrentLocale()->formatPrice((float)$payment['total'] / (int)$payment['nb'], $currency->iso_code).'</td>
						</tr>';
        }
        $this->html .= '
					</tbody>
