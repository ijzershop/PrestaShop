...
//House number
        if (!isset($configuration['payment_address']['house_number']['guest']['require'])) {
            $configuration['payment_address']['house_number']['guest']['require'] = 0;
        }
        if (!isset($configuration['payment_address']['house_number']['guest']['display'])) {
            $configuration['payment_address']['house_number']['guest']['display'] = 0;
        }
        if (!isset($configuration['payment_address']['house_number']['logged']['require'])) {
            $configuration['payment_address']['house_number']['logged']['require'] = 0;
        }
        if (!isset($configuration['payment_address']['house_number']['logged']['display'])) {
            $configuration['payment_address']['house_number']['logged']['display'] = 0;
        }
//House Number Extension
        if (!isset($configuration['payment_address']['house_number_extension']['guest']['require'])) {
            $configuration['payment_address']['house_number_extension']['guest']['require'] = 0;
        }
        if (!isset($configuration['payment_address']['house_number_extension']['guest']['display'])) {
            $configuration['payment_address']['house_number_extension']['guest']['display'] = 0;
        }
        if (!isset($configuration['payment_address']['house_number_extension']['logged']['require'])) {
            $configuration['payment_address']['house_number_extension']['logged']['require'] = 0;
        }
        if (!isset($configuration['payment_address']['house_number_extension']['logged']['display'])) {
            $configuration['payment_address']['house_number_extension']['logged']['display'] = 0;
        }
...
//House number
        if (!isset($configuration['shipping_address']['house_number']['guest']['require'])) {
            $configuration['shipping_address']['house_number']['guest']['require'] = 0;
        }
        if (!isset($configuration['shipping_address']['house_number']['guest']['display'])) {
            $configuration['shipping_address']['house_number']['guest']['display'] = 0;
        }
        if (!isset($configuration['shipping_address']['house_number']['logged']['require'])) {
            $configuration['shipping_address']['house_number']['logged']['require'] = 0;
        }
        if (!isset($configuration['shipping_address']['house_number']['logged']['display'])) {
            $configuration['shipping_address']['house_number']['logged']['display'] = 0;
        }
//House Number Extension
        if (!isset($configuration['shipping_address']['house_number_extension']['guest']['require'])) {
            $configuration['shipping_address']['house_number_extension']['guest']['require'] = 0;
        }
        if (!isset($configuration['shipping_address']['house_number_extension']['guest']['display'])) {
            $configuration['shipping_address']['house_number_extension']['guest']['display'] = 0;
        }
        if (!isset($configuration['shipping_address']['house_number_extension']['logged']['require'])) {
            $configuration['shipping_address']['house_number_extension']['logged']['require'] = 0;
        }
        if (!isset($configuration['shipping_address']['house_number_extension']['logged']['display'])) {
            $configuration['shipping_address']['house_number_extension']['logged']['display'] = 0;
        }
