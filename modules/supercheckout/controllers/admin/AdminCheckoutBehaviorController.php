...
class AdminCheckoutBehaviorController extends ModuleAdminController
{
    ...
    protected function calculateCheckoutBehaviour($start_date, $end_date)
    {
        ...
        $sql = "SELECT SUM(email) as email, "
                ...
                . "SUM(house_number) as house_number, (SUM(house_number)*100)/COUNT(*) as house_number_percent, "
                . "SUM(house_number_extension) as house_number_extension, (SUM(house_number_extension)*100)/COUNT(*) as house_number_extension_percent, "
                ...
                . "SUM(house_number_invoice) as house_number_invoice, (SUM(house_number_invoice)*100)/COUNT(*) as house_number_invoice_percent, "
                . "SUM(house_number_extension_invoice) as house_number_extension_invoice, (SUM(house_number_extension_invoice)*100)/COUNT(*) as house_number_extension_invoice_percent, "
