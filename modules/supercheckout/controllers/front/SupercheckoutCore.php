    ...
    protected function initCheckoutAddresses($id_country = 0, $id_state = 0, $postcode = '', $id_address_delivery = 0)
    {
        ...
        if ($this->context->cart->isVirtualCart()) {
            if (!$this->checkout_session->getIdAddressInvoice()) {
                ...
                $invoice_address->house_number = 0;
            ...
            if ((int) $id_address_delivery > 0) {
                ...
                if ($this->checkout_session->getIdAddressDelivery() == 0) {
                    ...
                    $delivery_address->house_number_extension = ' ';
                    ...
                    if (empty($delivery_address->house_number)) {
                        $delivery_address->house_number = 0;
                    }
    ...
    */
    ...
    protected function getGuestInformations()
    {
        ...
        return array(
            ...
            'house_number' => $address_delivery->house_number,
            'house_number_extension' => $address_delivery->house_number_extension,
            ...
            'house_number_invoice' => $address_invoice->house_number,
            'house_number_extension_invoice' => $address_invoice->house_number_extension,
            ...
            'invoice_house_number' => $address_invoice->house_number,
            'invoice_house_number_extension' => $address_invoice->house_number_extension,
    ...
    protected function confirmOrder()
    {
        ...
        if ((isset($posted_data['shipping_address_value']) && $posted_data['shipping_address_value'] == 1)
            ...
            $delivery_address->house_number = (!empty($posted_data['shipping_address']['house_number']))
                ? $posted_data['shipping_address']['house_number'] : ' ';
            $delivery_address->house_number_extension = (!empty($posted_data['shipping_address']['house_number_extension']))
