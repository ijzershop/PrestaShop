        ...
        if ($this->nb_products > 0) {
            ...
            if (isset($posted_data['use_for_invoice'])) {
                ...
                if (isset($this->context->cookie->supercheckout_temp_address_invoice)
                    ...
                    $temp_invoice_address->house_number = ' ';
                    $temp_invoice_address->house_number_extension = ' ';
...
//                return $response;
            ...
            if ($continue == 1 && !$this->context->cart->isVirtualCart() && ((isset($posted_data['shipping_address_value']) && $posted_data['shipping_address_value'] == 1)
                ...
                $delivery_address->house_number = (!empty($posted_data['shipping_address']['house_number'])) ? $posted_data['shipping_address']['house_number'] : ' ';

                $delivery_address->house_number_extension = (!empty($posted_data['shipping_address']['house_number_extension'])) ? $posted_data['shipping_address']['house_number_extension'] : ' ';
            ...
            if ($continue == 1 && !isset($posted_data['use_for_invoice']) && ((isset($posted_data['payment_address_value']) && $posted_data['payment_address_value'] == 1)
                ...
                $invoice_address->house_number = (!empty($posted_data['payment_address']['house_number']))
                                ? $posted_data['payment_address']['house_number'] : ' ';
                $invoice_address->house_number_extension = (!empty($posted_data['payment_address']['house_number_extension']))
                ...
                $invoice_address->house_number = (!empty($posted_data['payment_address']['house_number'])) ? $posted_data['payment_address']['house_number'] : ' ';
                $invoice_address->house_number_extension = (!empty($posted_data['payment_address']['house_number_extension'])) ? $posted_data['payment_address']['house_number_extension'] : ' ';
        ...
        if (!empty($address) && count($address) > 0 && $this->context->customer->logged == 1) {
            ...
            if (isset($result) && !empty($result) && $result != "" && $result) { //update
                $sql = 'UPDATE ' . _DB_PREFIX_ . 'kb_checkout_behaviour_stats '
                        ...
                        . ',company_invoice = 1 '
                        . ',address1_invoice = 1 '
                        . ',house_number_invoice = 1 '
                        . ',house_number_extension_invoice = 1 '
                        . ',address2_invoice = 1 '
                        . ',city_invoice = 1 '
    ...
    protected function updateSameAsShippingAddressDataInInvoice($filled)
    {
        if ($filled == 1) {
            ...
            $sql = 'UPDATE ' . _DB_PREFIX_ . 'kb_checkout_behaviour_stats '
                        ...
                        . ',company_invoice = 0 '
                        . ',address1_invoice = 0 '
                        . ',house_number_invoice = 0 '
                        . ',house_number_extension_invoice = 0 '
                        . ',address2_invoice = 0 '
                        . ',city_invoice = 0 '
            ...
            if (isset($result) && !empty($result) && $result != "") {
                $sql = 'UPDATE ' . _DB_PREFIX_ . 'kb_checkout_behaviour_stats '
                        ...
                        . ', house_number_invoice = ' . $result['house_number'] . ' '
                        . ', house_number_extension_invoice = ' . $result['house_number_extension'] . ' '
    ...
    protected function loadInvoiceAddress($id_country = 0, $id_state = 0, $postcode = 0, $id_address_invoice = 0)
    {
        ...
        if ($this->context->cart->isVirtualCart()) {
            ...
            if ($id_address_invoice == 0) {
                ...
                $invoice_address->house_number_extension = ' ';
