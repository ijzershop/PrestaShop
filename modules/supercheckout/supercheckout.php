...
//        $this->module_key = '68a34cdd0bc05f6305874ea844eefa05';
    ...
    public function install()
    {
        ...
        $stats_table = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'kb_checkout_behaviour_stats` (
                        ...
                        `house_number` int(1) DEFAULT 0 NOT NULL,
                        `house_number_extension` int(1) DEFAULT 0 NOT NULL,
                        ...
                        `house_number_invoice` int(1) DEFAULT 0 NOT NULL,
                        `house_number_extension_invoice` int(1) DEFAULT 0 NOT NULL,
