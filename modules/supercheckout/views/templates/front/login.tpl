{if $logged}
    <div class="myaccount rectangle-list text-center">
      <div class="accountOptions" role="group" aria-label="Mijn account buttons">
        U bent aangemeld als <b>{$customer_name}</b><br/>Wilt u een ander account gebruiken klik dan op <a href="{$sc_logout_url}" class="btn-link btn-danger btn-sm text-white">{l s='Logout' mod='supercheckout'}</a>
      </div>
  ...
  <div class="no-shipping-names-row d-none">
    <div class="row d-flex">
      <div class="form-group col-6 pr-0">
        ...
        <input  type="text" class="form-control percheckout-large-field " name="no_shipping_surname" id="input-no_shipping_surname" value="{Context::getContext()->customer->firstname}"/>
      </div>

      <div class="form-group col-6 pl-1">
        <label class="control-label" for="input-no_shipping_lastname">Achternaam:  <span style="display:inline;" class="supercheckout-required">*</span></label>
        <input  type="text" class="form-control percheckout-large-field " name="no_shipping_lastname" id="input-no_shipping_lastname" value="{Context::getContext()->customer->lastname}"/>
      </div>
      ...
      <label class="control-label" for="input-no_shipping_phone">Telefoonnummer: <span style="display:inline;" class="supercheckout-required">*</span></label>
        {assign var='first_address_loggedin' value=null}
          {if !isset($guest_information)}
            {if $customer.addresses && Configuration::get('MSTHEMECONFIG_EMPLOYEE_CUSTOMER_PROFILE', Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id) != Context::getContext()->customer->id}
            ...
            {else}
              <input type="text" class="form-control percheckout-large-field" name="no_shipping_phone" id="input-no_shipping_phone" value="{if Configuration::get('MSTHEMECONFIG_EMPLOYEE_CUSTOMER_PROFILE', Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id) == Context::getContext()->customer->id}0582123138{/if}"/>
            {/if}
          {/if}
    </div>
  </div>
...
{*      Start extra names by no shipping *}
      <div class="no-shipping-names-row">
          <div class="row d-flex">
            <div class="form-group col-6 pr-0">
              <label class="control-label" for="input-no_shipping_surname">Voornaam:  <span style="display:inline;" class="supercheckout-required">*</span></label>
              <input  type="text" class="form-control percheckout-large-field " name="no_shipping_surname" id="input-no_shipping_surname" value=""/>
            </div>

            <div class="form-group col-6 pl-1">
              <label class="control-label" for="input-no_shipping_lastname">Achternaam:  <span style="display:inline;" class="supercheckout-required">*</span></label>
              <input  type="text" class="form-control percheckout-large-field " name="no_shipping_lastname" id="input-no_shipping_lastname" value=""/>
            </div>
        ...
        {if $settings['fb_login']['enable'] eq 1 || $settings['google_login']['enable'] eq 1 || $settings['paypal_login']['enable'] eq 1}
            <div class="social-login">
                ...
                {if $settings['paypal_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        <a onclick="return !window.open(this.href, 'popup', 'width=500,height=500,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}&myPaypalLogin" class="btn azm-social azm-btn azm-border-bottom azm-paypal" style="color: #ffffff; background: #009cde;"><i class="fa fa-paypal"></i>Login with Paypal</a>
                        {*escape not required as contains url*}
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}&myPaypalLogin" class="btn azm-social azm-btn azm-border-bottom azm-paypal" style="color: #ffffff; background: #009cde;"><i class="fa fa-paypal"></i>Login with Paypal</a>
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                </div>
