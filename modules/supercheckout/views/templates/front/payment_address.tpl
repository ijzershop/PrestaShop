                ...
                {if $settings['payment_address'][$p_address_key][$user_type]['display'] eq 1 || (isset($settings['payment_address'][$p_address_key]['conditional']) && $settings['payment_address'][$p_address_key]['conditional'] eq 1)}
                    ...
                    {if $settings['payment_address'][$p_address_key]['html_format'] == 1}
                        ...
                        {if $p_address_key eq 'postcode'}
                            ...
                            {else}
                                <div class="sort_data col-12 pl-sm-0 pr-sm-0" data-percentage="{$settings['payment_address'][$p_address_key]['sort_order']|intval}" style="{$display_row}">
                                {/if}
                            ...
                            {elseif $settings['payment_address'][$p_address_key]['html_format'] == 2}
                                <div class="{if $p_address_key == 'id_country'}col-12{else}col-12 col-sm-6{/if} {if $p_address_key == 'postcode' || $p_address_key == 'phone' ||  $p_address_key == 'firstname'}pr-sm-0{elseif $p_address_key == 'city' || $p_address_key == 'phone_mobile' || $p_address_key == 'lastname'}pl-sm-1 {if $p_address_key == 'lastname'}pr-sm-0{/if}{/if}">
                                    <div class="form-group ">
                                        <label class="control-label"for="payment_address[{$p_address_key}]">{l s={$settings['payment_address'][$p_address_key]['title']} mod='supercheckout'}
                                            {if $p_address_key eq 'vat_number'}
                                                <span style="display:{if $need_vat}inline{else}none{/if};" class="supercheckout-required">*</span>
                        ...
                        {else}
                            {if $p_address_key eq 'postcode'}
                                <div class="sort_data col-12 col-sm-6 pl-0 pr-0" id="payment_post_code" data-percentage="{$settings['payment_address'][$p_address_key]['sort_order']|intval}" style="{$display_row}">
                                {else}
                                    ...
                                    {elseif $p_address_key == 'house_number'}
                                        <div class="sort_data col-8 col-sm-3 pl-sm-1 pr-sm-0 pr-0" data-percentage="{$settings['payment_address'][$p_address_key]['sort_order']|intval}" style="{$display_row}">
                                    {elseif $p_address_key == 'house_number_extension'}
                                        <div class="sort_data col-4 col-sm-3 pl-sm-1 pl-1 pr-0" data-percentage="{$settings['payment_address'][$p_address_key]['sort_order']|intval}" style="{$display_row}">
                                    {else}
