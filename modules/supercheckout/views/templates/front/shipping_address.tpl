                                    ...
                                    {else}
                                        ...
                                        {else}
                                          {if $p_address_key == 'city' || $p_address_key == 'address1'}
                                            <input autocomplete="off" type="text" name="shipping_address[{$p_address_key|escape:'htmlall':'UTF-8'}]" value="{if !isset($guest_information) && $existing_address}{$existing_address[$p_address_key]}{/if}" class="supercheckout-large-field form-control" readonly tabindex="-1"/>
                                          {else}
