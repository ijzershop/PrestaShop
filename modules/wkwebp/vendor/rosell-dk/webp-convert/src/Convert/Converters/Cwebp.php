...
class Cwebp extends AbstractConverter
{
    ...
    public static function getSuppliedBinariesInfo()
    {
        return self::$suppliedBinariesInfo;
    }
    ...
    private function getSuppliedBinaryPathForOS()
    {
        ...
        foreach ($files as $i => list($file, $hash)) {
            ...
            $binaryFile = _PS_MODULE_DIR_ . 'wkwebp/vendor/rosell-dk/webp-convert/cwebLib/' . $file;
