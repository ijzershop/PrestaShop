...
class DropdownInputField extends DynamicInputField
{
    ...
    {
        return (int) $this->field['settings']['hide_when_empty'] && empty($this->value);
    }
    ...
    public function displayValue()
    {
        ...
        if (isset($options[$id_dropdown_option])) {
            return $options[$id_dropdown_option]['label'];
        }
    ...
    public function getSKU()
    {
        ...
        $options = $this->field['options'];
        if (isset($options[$id_dropdown_option])) {
            return $options[$id_dropdown_option]['sku'];
        }
