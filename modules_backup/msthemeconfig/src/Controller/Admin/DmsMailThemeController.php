...
class DmsMailThemeController extends FrameworkBundleAdminController
{
    ...
    {
        if (Configuration::get('PS_MAIL_THEME', Context::getContext()->language->id, Context::getContext()->shop->getGroup()->id) !== $theme) {
            $this->addFlash(
                'error',
                $this->trans(
    ...
    public static function filterFooterBlocks($templateName, string $route = ''): string
    {
        ...
        return match ($route) {
            'admin_mail_theme_generate' => $instance->get('twig')->render('@Modules/msthemeconfig/mails/themes/modernesmid/components/footer_blocks.html.twig', [
            ...
            default => $instance->get('twig')->render('@Modules/msthemeconfig/mails/themes/modernesmid/components/footer_blocks.html.twig', [
                'footer_visibles' => (array)$templateBlocksData,
                'locale' => Context::getContext()->language->locale,
