 ...
 * @since 1.5.0
 */
class Ps_CreditpaymentPaymentModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
      ...
      'back_url' => $this->context->link->getPageLink('order', true, NULL, "step=3"),
			'confirm_url' => $this->context->link->getModuleLink('ps_creditpayment', 'validation', [], true),
			'image_url' => $this->module->getPathUri() . 'ps_creditpayment.png',
