...
class Ps_Shoppingcart extends Module implements WidgetInterface
{
    ...
    public function hookDisplayHeader()
    {
        ...
        if (Configuration::get('PS_BLOCK_CART_AJAX')) {
            ...
            $add2orderCarrier = (int)Configuration::get('KOOPMANORDEREXPORT_SELECT_ADDEDORDER_CARRIER');
    ...
    public function getWidgetVariables($hookName, array $params)
    {
        ...
        $cart_url = $this->getCartSummaryURL();
            $params['cart'] =  (new CartPresenter())->present($params['cart'] ?? $this->context->cart);
            $params['refresh_url'] = $this->context->link->getModuleLink('ps_shoppingcart', 'ajax', [], null, $this->context->language->id, $this->context->shop->id, false);
            $params['cart_url'] = $cart_url;
            $params['order_url'] = $this->context->link->getPageLink('order');
    ...
    public function renderWidget($hookName, array $params)
    {
        ...
        $attr = $this->getWidgetVariables($hookName, $params);
        $this->smarty->assign($attr);

        if(isset($params['p']) && $params['p'] === 'top_header'){
            return $this->fetch('themes/modernesmid_theme/modules/ps_shoppingcart/ps_shoppingcart-list.tpl');
        } else {
            return $this->fetch('themes/modernesmid_theme/modules/ps_shoppingcart/ps_shoppingcart.tpl');
        }
    }
    ...
    public function renderModal(Cart $cart, $id_product, $id_product_attribute, $id_customization)
    {
        ...
        return $this->fetch('themes/modernesmid_theme/modules/ps_shoppingcart/modal.tpl');
    }
