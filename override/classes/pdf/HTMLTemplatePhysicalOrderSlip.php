 ...
 * @since 1.5
 */
class HTMLTemplatePhysicalOrderSlip extends HTMLTemplateInvoice
{
    public $order;
    public $order_slip;
    ...
    public function getContent()
    {
        ...
        return $this->smarty->fetch($this->getTemplate('physical-order-slip'));
    }
    ...
    {
        return Configuration::get('PS_CREDIT_SLIP_PREFIX', Context::getContext()->language->id, null, $this->cart->id_shop) . sprintf('%06d', $this->cart->id) . '.pdf';
    }
