	...
	public function renderForm()
    {
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
				    'type' => 'text',
				    'label' => $this->trans('House number', array(), 'Admin.Orderscustomers.Feature'),
				    'name' => 'house_number',
				    'required' => true,
				    'col' => '4',
				    'hint' => $this->trans('House number', array(), 'Admin.Orderscustomers.Feature'),
				), 
                array(
                    'type' => 'text',
                    'label' => $this->trans('House number extension', array(), 'Admin.Orderscustomers.Feature'),
                    'name' => 'house_number_extension',
                    'required' => false,
                    'col' => '4',
                    'hint' => $this->trans('House number extension', array(), 'Admin.Orderscustomers.Feature'),
                ),  
                array(
                    'type' => 'text',
