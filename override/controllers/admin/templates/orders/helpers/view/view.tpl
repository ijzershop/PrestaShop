        ...
        <form id="migrateToCustomer" class="row">
          <div class="input-group ui-widget col-xs-12">
            ...
            <div class="input-group-append">
              <button type="button" id="migrateOrder" class="btn btn-secondary btn-primary"><i class="icon-paperclip"></i></button>
            </div>
          </div>
