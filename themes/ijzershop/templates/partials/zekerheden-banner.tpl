    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row hidden-md-down zekerheden-banner-container">
                <!-- Levering -->
                <div class="col-lg-2-4 col-sm-2-4 col-12 ">
                    <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                            <div class="sttext_item_content">
                                <span>
                                    <span>
                                        <a href="/content/16-bezorgen">
                                            <span class="zekerheden-banner-text">Levering 90% binnen 1-2 werkdagen</span>
                                        </a>
                                    </span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="sttext_item_content">
                                <span>
                                    <span>
                                        <a href="/content/37-offerte-aanvragen">
                                            <span class="zekerheden-banner-text">Offerte binnen 1 werkdag</span>
                                        </a>
                                    </span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="sttext_item_content">
                                <span>
                                    <span>
                                        <a href="https://www.ijzershop.nl/content/17-constructiewerk">
                                            <span class="zekerheden-banner-text">Verstekzagen, lassen en boren mogelijk</span>
                                        </a>
                                    </span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="sttext_item_content">
                                <span>
                                    <span>
                                        <a href="/content/15-betalen">
                                            <span class="zekerheden-banner-text">Verzending Nederland, altijd € 7,75 excl BTW</span>
                                        </a>
                                    </span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="sttext_item_content">
                                <span>
                                    <span>
                                        <a href="/content/33-informatieaanvraag">
                                            <span class="zekerheden-banner-text">Rechtstreeks advies van de vakman zelf</span>
                                        </a>
                                    </span>
                                </span>
                            </div>
