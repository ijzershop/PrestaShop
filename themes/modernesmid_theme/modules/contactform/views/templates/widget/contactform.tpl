...
{if Context::getContext()->controller->php_self == 'category' || Context::getContext()->controller->php_self == 'contact' || Context::getContext()->controller->php_self == 'search' }
     <div class="col-12 ">
      ...
      <div class="h5 w-100 text-center">{if Context::getContext()->controller->php_self == 'search'}Uw zoekopdracht heeft geen resultaten opgeleverd. Wilt u weten of de {Configuration::get('PS_SHOP_NAME', Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id)} een alternatief kan leveren?{else}Mist u een product of wilt u weten of de {Configuration::get('PS_SHOP_NAME',Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id)} een alternatief kan leveren?{/if} Vraag het ons via het onderstaande formulier.</div>
      </div>
