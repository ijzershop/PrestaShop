  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-12 error-message d-none" id="product-comment-message">
        ...
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
              {if $criterions|@count > 0}
                <ul class="list-unstyled" id="criterions_list">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 post-comment-buttons">
              <button type="button" class="btn-comment-big btn btn-dark btn-comment-inverse" data-dismiss="modal" aria-label="{l s='Cancel' d='Modules.Productcomments.Shop'}">
                {l s='Cancel' d='Modules.Productcomments.Shop'}
              </button>
              <button type="submit" class="btn-comment-big btn btn-success btn-comment">
