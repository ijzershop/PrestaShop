...
<div class="dropdown">
  <a class="dropdown-toggle text-decoration-none text-white text-sm-white" href="#" data-target="customer-menu-dropdown-menu" role="button" id="customer-menu-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
    <i class="fasl fa-user-circle d-block d-sm-block d-md-none d-lg-none logged mr-1"></i> <span class="hidden-sm-down">{$customerName}</span>
  </a>
  <div class="dropdown-menu" id="customer-menu-dropdown-menu" aria-labelledby="customer-menu-dropdown">
      <a
        ...
        rel="nofollow"
      >
        <i class="fasl fa-user-circle logged mr-1"></i> {l s='Your account' d='Shop.Theme.Customeraccount'}
      </a>
      <a
        ...
        rel="nofollow"
      >
        <i class="fasl fa-key mr-1"></i> {l s='Sign out' d='Shop.Theme.Actions'}
      </a>
  </div>
</div>
    {else}
