...
<table id="summary-tab" width="100%">
    ...
    <tr>
        <td colspan="5" class="left white"><b>{l s='Product(s) in the order' mod='psgdpr'} {$order['reference']|escape:'html':'UTF-8'}:</b></td>
    </tr>
    <tr>
        <td colspan="5" class="center white">
            <table id="total-tab" width="100%">
                ...
                <tr>
                    ...
                    <td class="center white">{AttributeGroup::stripSawCutModuleAttributeGroupName($product['product_name'], Context::getContext()->cookie->id_lang)}</td>
