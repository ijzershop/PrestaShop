...
<style>
    ...
    #cookieNoticeContent {
        {/literal}
        {if Configuration::get('uecookie_padding',Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id) != ""}
            padding:{Configuration::get('uecookie_padding', Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id)}px;
        {/if}
        {literal}
    }
        ...
        <table style="margin: 10px auto;">
            <tr class="d-block">
                <td id="cookieNoticeCheckbox">
                      <p>Deze website maakt gebruik van cookies. Zie voor meer informatie bij onze <a class="text-decoration-none text-dark" href="{$link->getCMSLink(Configuration::get('MSTHEMECONFIG_CONTACTPAGE_PRIVACY', Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id))}"><i class="fasl fa-chevron-right" style="height:10px;"></i> Privacy voorwaarden</a></p>
                      <p>
                        <label for="delete-all-after" class="switch mx-auto">
                          <input type="checkbox" name="delete-all-after" id="delete-all-after">
                          <span class="slider round"></span>
                      </label> Verwijder al mijn gegevens na aankoop of verlaten van de site. U kunt deze gegevens na registratie ook zelf inzien en laten verwijderen. <a class="text-decoration-none text-dark" href="{$link->getCMSLink(Configuration::get('MSTHEMECONFIG_AVG_INFO_PAGE',Context::getContext()->language->id, Context::getContext()->shop->id_shop_group, Context::getContext()->shop->id))}"><i class="fasl fa-chevron-right" style="height:10px;"></i> Zie hier voor meer informatie</a>
                      </p>
                </td>
              <td width="90px">
...
{*            <td id="cookieNoticeCheckbox">*}
{*              <p>Deze website maakt gebruik van cookies. Zie voor meer informatie bij onze <a class="text-decoration-none text-dark" href="{$link->getCMSLink(Configuration::get('MSTHEMECONFIG_CONTACTPAGE_PRIVACY'))}"><i class="fasl fa-chevron-right" style="height:10px;"></i> Privacy voorwaarden</a></p>*}
{*              <p>*}
{*                <label for="delete-all-after" class="switch mx-auto">*}
{*                  <input type="checkbox" name="delete-all-after" id="delete-all-after">*}
{*                  <span class="slider round"></span>*}
{*                </label> Verwijder al mijn gegevens na aankoop of verlaten van de site. U kunt deze gegevens na registratie ook zelf inzien en laten verwijderen. <a class="text-decoration-none text-dark" href="{$link->getCMSLink(Configuration::get('MSTHEMECONFIG_AVG_INFO_PAGE'))}"><i class="fasl fa-chevron-right" style="height:10px;"></i> Zie hier voor meer informatie</a>*}
{*              </p>*}
{*              <p>*}
