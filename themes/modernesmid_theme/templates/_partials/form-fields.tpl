      ...
      {elseif $field.type === 'checkbox'}
        ...
        {block name='form_field_item_checkbox'}
          <span class="custom-checkbox form-check form-check-inline">
              <input name="{$field.name}" class="form-check-input" type="checkbox" value="1" {if $field.value}checked="checked"{/if} {if $field.required}required{/if}><label class="form-check-label">{$field.label nofilter}</label>
          </span>
        {/block}
