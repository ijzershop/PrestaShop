...
<div id="contact-info-box" class="d-none">
  <table width="100%" height="100%" style="border-color:#3b56ad;border-style:solid;border-width:1px 1px 0px 1px;">
    ...
    <tr style="display: none;" id="info-row-whatsapp"><td><a class="btn btn-primary rounded-0 w-100" href="https://api.whatsapp.com/send?phone={str_replace(' ','',Configuration::get('MSTHEMECONFIG_HEADER_WHATSAPP_LINK'))}"><i class="fab fa-whatsapp float-left fa-2x"></i> App met ons</a></td></tr>
    ...
    <tr id="info-row-maps"><td><a class="btn btn-primary rounded-0 w-100" href="https://www.google.com/maps/place/{Configuration::get('MSTHEMECONFIG_FOOTERTOP_STOREINFO_GOOGLE_STRING')}"><i class="fa-sharp fa-map-marker fa-2x float-left"></i> Vind ons</a></td></tr>
  </table>
</div>
