          ...
          <table class="h-100 w-100">
            <tr>
              <td class="align-middle">
                ...
                <span class="h6 product-title p-0"><a class="text-decoration-none text-dark" href="{$product.url}">{$product.name}</a></span><br /><small class="help-text">{$dynamicProductConfig.indication_msg} {$product.name}</small><br /><span class="product-description-short">{$product.description_short nofilter}</span>
                {else}
