...
{block "form_field"}
  {if $field.name === 'password' and $guest_allowed}
      <p class="form-informations">
        <span class="font-weight-bold form-informations-title">{l s='Create an account' d='Shop.Theme.Checkout'}</span> <span class="font-italic form-informations-option">{l s='(optioneel)' d='Shop.Theme.Checkout'}</span>
        <br>
