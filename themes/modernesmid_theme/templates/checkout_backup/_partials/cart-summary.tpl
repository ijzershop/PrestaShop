    ...
    <div class="card-body">
      ...
      {block name='cart_summary_products'}
        <div class="cart-summary-products">
          <span class="label font-weight-bold text-dark">{if (int)$cart.products_count > 1}Producten{else}Product{/if} ({$cart.products_count})</span>  <a href="#" data-toggle="collapse" class="text-dark text-decoration-none" data-target="#cart-summary-product-list"><i class="fasl fa-chevron-down"></i></a>
            ...
            <div class="collapse show" id="cart-summary-product-list">
              <ul class="media-list list-unstyled row">
                ...
                {foreach from=$cart.products item=product key=key}
                  ...
                  <li class="media col-12 {if $key > 0}border-top{/if} pt-1">{include file='checkout/_partials/cart-summary-product-line.tpl' product=$product}</li>
                {/foreach}
              </ul>
            </div>
          {/block}
