...
{block name='step_content'}
  <div class="js-address-form col-12">
    <form
      method="POST"
    ...
    >
      ...
      {if !$use_same_address}
        <a class="h6 font-weight-bolder">{l s='Shipping Address' d='Shop.Theme.Checkout'}</a>
      {/if}
      ...
      {elseif $customer.addresses|count > 0}
        <div id="delivery-addresses" class="address-selector js-address-selector overflow-auto row" style="max-height: 300px;">
        ...
        <p class="add-address">
          <a class="btn btn-link" href="{$new_address_delivery_url}"><i class="fasl fa-plus"></i> {l s='add new address' d='Shop.Theme.Actions'}</a>
        </p>
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a class="btn btn-link" href="{$new_address_invoice_url}"><i class="fasl fa-plus"></i> {l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
      ...
      {if !$form_has_continue_button}
        <div class="clearfix">
          <button type="submit" class="btn btn-success w-100 continue float-xs-right" name="confirm-addresses" value="1" {if !$customer.addresses}disabled{/if}>
