              ...
              <div class="row">
                <div class="col-3 pl-0 pr-0" style="max-width:70px;">
                  {if $option.module_name == 'ps_wirepayment'}
                      <img class="text-align-left" style="height:auto;width:50px!important;" src="/upload/bankoverschrijving.png">
                  {else}
                    {if $option.logo}
                      <img class="text-align-left" style="height:auto;width:50px!important;" src="{$option.logo}">
                    {/if}
                  {/if}
                  </div>
