...
{*                    {/if}*}
      ...
      <div class="footer_block border-bottom pb-mb-4 {if Configuration::get('MSTHEMECONFIG_ABOUT_FOOTERTOP_BOX_ACTIVE', true)}col-12 col-md-4 col-lg-2{else}col{/if} pt-0 pt-md-1 pt-lg-0 pl-md-0">
            <div class="title_block ">
