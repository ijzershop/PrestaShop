...
{block name='page_content'}
  {if $cart_rules}
    <table class="table table-striped table-bordered d-none d-sm-none d-md-block d-lg-block w-100">
    ...
    <div class="cart-rules d-block d-sm-block d-md-none d-lg-none">
      {foreach from=$cart_rules item=cart_rule}
        <div class="cart-rule">
          <ul>
            <li>
