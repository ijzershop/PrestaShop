...
{*           <th>{l s='Tracking' d='Shop.Theme.Checkout'}</th> *}
      ...
      <tbody>
          ...
          <tr>
            ...
            <td class="text-sm-center d-sm-none d-none">
              {if $order.details.invoice_url}
                <a href="{$order.details.invoice_url}"><i class="fa-2x fasl fa-file-pdf"></i></a>
              {else}
                -
              {/if}
            </td>
        ...
        {*  <td class="text-center">
              <button data-history="{json_encode($order.history)}" data-order-reference="{$order.details.reference}" data-toggle="modal" data-target="#trackingModal" class="btn-link btn text-dark showOrderTracking"><i class="fasl fa-truck fa-2x"></i></a>
            </td> *}
          </tr>
        {/foreach}
      </tbody>
              ...
              <div class="vprogress w-100">
                <div class="col-12 vprogress-row">
                  <div class="circle" id="trackingModalOrderReceived">
                    <span class="label" title="Bestelling ontvangen" data-toggle="popover" data-content="Uw bestelling is ontvangen"><i class="fasl fa-shopping-basket"></i></span>
                  </div>
                    <span class="title">Bestelling ontvangen</span>
                </div>
                <div class="col-12 vprogress-row">
                  <div class="circle failed"  id="trackingModalPaymentReceived">
                    <span class="label" title="Betaling ontvangen" data-toggle="popover" data-content="De betaling voor de bestelling is geverifieerd"><i class="fasl fa-money-bill-alt"></i></span>
                  </div>
                    <span class="title">Betaling ontvangen</span>
                </div>
                <div class="col-12 vprogress-row">
                  <div class="circle" id="trackingModalOrderPicked">
                    <span class="label" title="Bestelling word voorbereid" data-toggle="popover" data-content="Uw bestelling word momenteel voorbereid"><i class="fasl fa-dolly"></i></span>
                  </div>
                    <span class="title">Bestelling word voorbereid</span>
                </div>
                <div class="col-12 vprogress-row">
                  <div class="circle" id="trackingModalOrderReadyForShipping">
                    <span class="label" title="Bestelling klaar voor verzending" data-toggle="popover" data-content="Uw bestelling is ingepakt en staat klaar voor verzending"><i class="fasl fa-boxes"></i></span>
                  </div>
                    <span class="title">Bestelling klaar voor verzending</span>
                </div>
                <div class="col-12 vprogress-row">
                  <div class="circle" id="trackingModalOrderTransferredToTransmission">
                    <span class="label" title="Overgedragen aan transmission" data-toggle="popover" data-content="We hebben uw pakket overgedragen aan transmission"><i class="fasl fa-pallet"></i></span>
                  </div>
                    <span class="title">Overgedragen aan transmission</span>
                </div>
                <div class="col-12 vprogress-row">
                  <div class="circle" id="trackingModalOrderArivedTransmissionDepot">
                    <span class="label" title="Aangekomen op transmission depot" data-toggle="popover" data-content="Uw pakket is aangekomen op het depot van Transmission"><i class="fasl fa-warehouse"></i></span>
                  </div>
                    <span class="title">Aangekomen op transmission depot</span>
                </div>
                <div class="col-12 vprogress-row">
                  <div class="circle" id="trackingModalOrderDeliveryOnRoute">
                    <span class="label" title="Bezorger onderweg" data-toggle="popover" data-content="De bezorgen van transmission is momenteel onderweg om u het pakket te bezorgen"><i class="fasl fa-truck"></i></span>
                  </div>
                    <span class="title">Bezorger onderweg</span>
                </div>
                <div class="col-12 vprogress-row">
                  <div class="circle" id="trackingModalOrderDeliverd">
                    <span class="label" title="Afgeleverd" data-toggle="popover" data-content="Het pakket is afgeleverd"><i class="fasl fa-check"></i></span>
                  </div>
