...
{block name='page_content'}
  {block name='order_infos'}
    <div id="order-infos" class="row bg-light pt-2">
      <div class="box col-12">
          <div class="row">
            <div class="col-{if $order.details.reorder_url}10 pr-0{else}12{/if}">
              <strong class="h5">
                {l
            ...
            {if $order.details.reorder_url}
              <div class="col-2 text-xs-right pl-0 pr-0">
                <a href="{$order.details.reorder_url}" class="btn btn-sm button-primary text-white">{l s='Opnieuw bestellen' d='Shop.Theme.Actions'}</a>
              </div>
            {/if}
  ...
  {block name='order_history'}
    <section id="order-history" class="box row pt-2">
      <h4 class="col-12 h4">{l s='Follow your order\'s status step-by-step' d='Shop.Theme.Customeraccount'}</h4>
      <div class="table-responsive w-100">

        <table class="table table-striped d-none d-sm-table d-md-table d-lg-table col-12 p-0">
          <thead>
            <tr>
          ...
          <tbody>
            {foreach from=$order.history item=state}
              <tr>
                ...
                <td>
                  <span class="label label-pill {$state.contrast}">
                    {$state.ostate_name}
                  </span>
                </td>
              </tr>
      ...
      <div class="d-block d-sm-none d-md-none d-lg-none history-lines col-12">
        {foreach from=$order.history item=state}
...
{*     <div class="box row">
  ...
  {block name='addresses'}
    <div class="addresses row bg-light pt-2">
      {if $order.addresses.delivery}
        <div class="col-lg-6 col-md-6 col-sm-6">
          <article id="delivery-address" class="box">
            <h5 class="h5">{l s='Aflever adres' d='Shop.Theme.Checkout'}</h5>
            <address>
            {$order.addresses.delivery.formatted nofilter}</address>
          </article>
        </div>
      {/if}
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <article id="invoice-address" class="box">
          <h5 class="h5">{l s='Factuur adres' d='Shop.Theme.Checkout'}</h5>
...
{*   {block name='order_carriers'}
    {if $order.shipping}
      <div class="box row pt-2">
        ...
        <table class="w-100 table table-striped d-none d-sm-none d-md-block d-lg-block">
          <thead class="w-100 thead-default">
            <tr>
        ...
        <div class="d-block d-sm-block d-md-none d-lg-none shipping-lines">
          {foreach from=$order.shipping item=line}
