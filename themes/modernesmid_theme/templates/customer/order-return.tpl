  ...
  {block name='order_return_infos'}
    <div id="order-return-infos" class="card">
      <div class="card-block col">
        ...
        <p class="col">{l s='We have logged your return request.' d='Shop.Theme.Customeraccount'}</p>
        <p class="col">{l
        ...
        <p class="col">{l s='List of items to be returned:' d='Shop.Theme.Customeraccount'}</p>
