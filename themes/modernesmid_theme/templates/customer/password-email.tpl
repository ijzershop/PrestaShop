...
{block name='page_content'}
  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <header>
      <p class="col-12 send-renew-password-link">{l s='Please enter the email address you used to register. You will receive a temporary link to reset your password.' d='Shop.Theme.Customeraccount'}</p>
    </header>

    <section class="form-fields col-12 pb-4">
      <div class="form-group center-email-fields row">
        ...
        <button class="form-control-submit btn btn-primary" name="submit" type="submit">{l s='Send reset link' d='Shop.Theme.Actions'}</button>
      </div>
    </section>
...
<div class="col-12">
  ...
  <a href="{$urls.pages.my_account}" class="account-link">
    <i class="fasl fa-chevron-left"></i>
