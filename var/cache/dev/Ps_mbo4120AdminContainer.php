...
class Ps_mbo4120AdminContainer extends Container
{
    ...
    {
        return $this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, 'C:\\wampserver\\www\\ijzershop8.local/var/cache/dev\\%/ps_mbo');
    }
    ...
    {
        return $this->services['mbo.doctrine.cache.provider'] = new \Symfony\Component\Cache\DoctrineProvider(($this->services['mbo.doctrine.cache.adapter'] ?? ($this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, 'C:\\wampserver\\www\\ijzershop8.local/var/cache/dev\\%/ps_mbo'))));
    }
