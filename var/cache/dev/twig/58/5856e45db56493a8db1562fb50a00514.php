...
class __TwigTemplate_86ea54584571868a085abf6a6f269572 extends Template
{
    private $source;
    private $macros = [];
...
<a class=\"";
  ...
  ";
        // line 48
        if (twig_in_filter(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 48, $this->source); })()), "id", [], "any", false, false, false, 48), [0 => "print_invoice", 1 => "print_delivery_slip"])) {
            // line 49
            echo "    target=\"_blank\"
  ";
        }
   ...
   data-clickable-row=\"";
        // line 52
        echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "options", [], "any", false, true, false, 52), "clickable_row", [], "any", true, true, false, 52)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "options", [], "any", false, true, false, 52), "clickable_row", [], "any", false, false, false, 52), false)) : (false)), "html", null, true);
        echo "\"
>
  ";
        // line 54
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 54, $this->source); })()), "icon", [], "any", false, false, false, 54))) {
            // line 55
            echo "    <i class=\"material-icons\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 55, $this->source); })()), "icon", [], "any", false, false, false, 55), "html", null, true);
            echo "</i>
  ";
        }
        // line 57
        echo "  ";
        if ( !twig_get_attribute($this->env, $this->source, (isset($context["attributes"]) || array_key_exists("attributes", $context) ? $context["attributes"] : (function () { throw new RuntimeError('Variable "attributes" does not exist.', 57, $this->source); })()), "tooltip_name", [], "any", false, false, false, 57)) {
            // line 58
            echo "    ";
...
";
    ...
    {
        return array (  143 => 60,  137 => 58,  134 => 57,  128 => 55,  126 => 54,  121 => 52,  118 => 51,  114 => 49,  112 => 48,  109 => 47,  104 => 45,  100 => 43,  98 => 42,  94 => 41,  90 => 40,  84 => 39,  81 => 38,  75 => 37,  72 => 36,  68 => 35,  65 => 34,  62 => 33,  60 => 32,  57 => 31,  53 => 29,  51 => 28,  48 => 27,  46 => 26,  43 => 25,);
    }
...
<a class=\"{{ class }} grid-{{ action.name|lower|replace({' ': '-'}) }}-row-link\"
  ...
  {% if action.id in ['print_invoice', 'print_delivery_slip'] %}
    target=\"_blank\"
  {% endif %}
...
", "@PrestaShop/Admin/Common/Grid/Actions/Row/link.html.twig", "C:\\wampserver\\www\\ijzershop8.local\\modules\\msthemeconfig\\views\\PrestaShop\\Admin\\Common\\Grid\\Actions\\Row\\link.html.twig");
    }
}
