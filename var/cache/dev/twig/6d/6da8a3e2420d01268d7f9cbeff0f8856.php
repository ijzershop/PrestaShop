 ...
 *#}
{{ 'Discover the best-selling modules of this category in the %link% page.' | trans({'%link%': '<a href=\"'~ categoryLink ~ '\">'~categoryName~'</a>'}, 'Modules.Mbo.Modulescatalog') | raw }}", "@Modules/ps_mbo/views/templates/hook/twig/module_manager_empty_category.html.twig", "C:\\wampserver\\www\\ijzershop8.local\\modules\\ps_mbo\\views\\templates\\hook\\twig\\module_manager_empty_category.html.twig");
    }
}
